...
,p_release=>'24.2.11'
,p_default_workspace_id=>8842403848446731
,p_default_application_id=>115
,p_default_id_offset=>8992232819801658
,p_default_owner=>'JESS_DEV_1'
);
end;
/
 
prompt APPLICATION 115 - Team Calendar
--
-- Application Export:
--   Application:     115
--   Name:            Team Calendar
--   Exported By:     JESS_DEV_1
--   Flashback:       0
...
,p_owner=>nvl(wwv_flow_application_install.get_schema,'JESS_DEV_1')
...
,p_application_group=>wwv_flow_imp.id(188524642056771119)
...
,p_authentication_id=>wwv_flow_imp.id(8949439553743156471)
...
,p_pass_ecid=>'N'
,p_security_scheme=>wwv_flow_imp.id(3264005987013937606)
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_imp.id(1760304011110023130)
...
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(1225926300646360999)
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1225926300646360999)
,p_name=>'Navigation Bar'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1225927107581361003)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1760366320161131191)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1760366640041134744)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Preferences'
,p_list_item_link_target=>'f?p=&APP_ID.:28:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-heart-o'
,p_parent_list_item_id=>wwv_flow_imp.id(1760366320161131191)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1071975796089440774)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1071976114857442878)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1760366937414138065)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1640718783308587002)
,p_name=>'Mobile Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1701883054499917515)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1760304011110023130)
,p_name=>'Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1760304131428023137)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1760304232749023137)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1760304314024023137)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1760304441130023137)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1760304512461023137)
,p_list_item_display_sequence=>5
,p_list_item_link_text=>'Administration'
,p_list_item_link_target=>'f?p=&APP_ID.:26:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-gear'
,p_security_scheme=>wwv_flow_imp.id(3264005803734937606)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(2204486196811483800)
,p_name=>'Event Actions'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2204486371680483810)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2204486853198483824)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(2479769812353486631)
,p_name=>'Preferences'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(2479770149161486632)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(3264011192861964374)
,p_name=>'Access Control'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(142007892893032024)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3264012094979964375)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1446838208777541292)
,p_list_item_display_sequence=>40
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(3264012509532964376)
,p_name=>'Administration'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1866216312305452422)
,p_list_item_display_sequence=>10
...
,p_security_scheme=>wwv_flow_imp.id(3264005803734937606)
,p_required_patch=>wwv_flow_imp.id(1866183829626190037)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3264012784315964376)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1335993299868109678)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1991379332434788357)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3264856297696825311)
,p_list_item_display_sequence=>50
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3265171612925104078)
,p_list_item_display_sequence=>60
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3314604603874239214)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1362952113259227129)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1326189084512744662)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1847223523182834415)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1683829473019026245)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(3343169996194735628)
,p_name=>'Activity Reporting'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3343170213382735629)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(8035067569609599620)
,p_name=>'Admin Email'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8035068588656605097)
,p_list_item_display_sequence=>5
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8035698168074788357)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8035699479155791564)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(560046420843780449)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(560046652913780465)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(560046882866780482)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(668411397315327013)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(2210934023070195978)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(29069386474761742)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>187973429
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(30371939581256654)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(30560994539232615)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>37167665066283
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(30561346719232615)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(30584959408081154)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(128914475108650642)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(149944376019939220)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(152283662978240204)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(205198619047268557)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(635777419779368141)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37166093806701
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1149554110677236748)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1796660370740153143)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1863361006419435238)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1949272127850381265)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(3264005803734937606)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(3264005987013937606)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(3264006312904937606)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(8949483251506219789)
,p_name=>'is Admin'
,p_scheme_type=>'NATIVE_FUNCTION_BODY'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'for c1 in (',
...
wwv_flow_imp_shared.create_acl_role(
 p_id=>wwv_flow_imp.id(610283561765580719)
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(3223707413012002118)
,p_icon_sequence=>10
...
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(7988965466568067558)
...
begin
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(7418109045754035281)
,p_process_sequence=>1
...
,p_process_clob_language=>'PLSQL'
,p_security_scheme=>wwv_flow_imp.id(3264006312904937606)
...
begin
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(1547709303850448505)
,p_process_sequence=>1
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1335971984654977046)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1866280416724794801)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1886340780607271960)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1866345667786619494)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1866280688846798134)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1645199716451985860)
,p_name=>'EXTERNAL_INTERNAL_BO'
,p_protection_level=>'I'
,p_required_patch=>wwv_flow_imp.id(1640732170941805634)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1701211759611987639)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(7989568170880355512)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(8035927276534301607)
,p_name=>'HOST_URL'
,p_protection_level=>'S'
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(3265302701236099269)
,p_name=>'LAST_VIEW'
,p_protection_level=>'S'
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1866184095246194392)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1866184829189203533)
...
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(1335976701463984510)
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(1645201791929994130)
,p_computation_sequence=>10
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(1645217127310009375)
,p_computation_sequence=>10
,p_computation_item=>'EXTERNAL_INTERNAL_BO'
,p_computation_point=>'ON_NEW_INSTANCE'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(1701212032002997813)
,p_computation_sequence=>10
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(1866185450847208855)
,p_computation_sequence=>10
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(1866185593585211722)
,p_computation_sequence=>10
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(1866185864033213432)
,p_computation_sequence=>10
,p_computation_item=>'MULTIPLE_CAL_BO'
,p_computation_point=>'ON_NEW_INSTANCE'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(1886341255737289491)
,p_computation_sequence=>10
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(8035928184845304033)
,p_computation_sequence=>10
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(142001054409004032)
,p_lov_name=>'ACCESS CONTROL SCOPE1'
,p_lov_query=>'.'||wwv_flow_imp.id(142001054409004032)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(142001387777004037)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Readers'
,p_lov_return_value=>'PUBLIC_READONLY'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(142001768334004037)
,p_lov_disp_sequence=>2
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3265361500307657276)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(1866314312150316370)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(1929968497944809804)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(1878281827440597031)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(9168215031992839694)
,p_lov_name=>'CHECKBOX'
,p_lov_query=>'.'||wwv_flow_imp.id(9168215031992839694)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(9168215331074839695)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>' '
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3303465383768843428)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(1640738292858826243)
,p_lov_name=>'CONTACTS'
,p_lov_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8035732977349885667)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8035932760173315892)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8949446355080156640)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(7977282571735632073)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3265404805932340208)
,p_lov_name=>'EVENTS'
,p_lov_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3265168406235067362)
,p_lov_name=>'NOTIFICATION TYPE'
,p_lov_query=>'.'||wwv_flow_imp.id(3265168406235067362)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3265168700112067363)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Yellow'
,p_lov_return_value=>'YELLOW'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3265168886143067364)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(9168187337776708901)
,p_lov_name=>'RECUR FREQUENCY'
,p_lov_query=>'.'||wwv_flow_imp.id(9168187337776708901)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(9168187651013708913)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Daily'
,p_lov_return_value=>'D'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(9168187853425708924)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'every Weekday (M-F)'
,p_lov_return_value=>'WD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(9168188044490708924)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'every Week (same day of week)'
,p_lov_return_value=>'W'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(9168188232862708924)
,p_lov_disp_sequence=>4
,p_lov_disp_value=>'every 2 Weeks (same day of week)'
,p_lov_return_value=>'2W'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(9168188457011708924)
,p_lov_disp_sequence=>5
,p_lov_disp_value=>'each Month (same date)'
,p_lov_return_value=>'M'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(4102522623562770277)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3266333307969419796)
,p_lov_name=>'ROWS'
,p_lov_query=>'.'||wwv_flow_imp.id(3266333307969419796)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3266333505211419797)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'10'
,p_lov_return_value=>'10'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3266333685777419798)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'20'
,p_lov_return_value=>'20'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3266333885720419798)
,p_lov_disp_sequence=>30
,p_lov_disp_value=>'100'
,p_lov_return_value=>'100'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3266334106449419798)
,p_lov_disp_sequence=>40
,p_lov_disp_value=>'1000'
,p_lov_return_value=>'1000'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(3266334309158419798)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8949571757917609548)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(3266169390180304595)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8048412175983563031)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8043886771884599218)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8022798473533058657)
,p_lov_name=>'UPD_REQUEST_AF'
,p_lov_query=>'.'||wwv_flow_imp.id(8022798473533058657)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(8022798761127058662)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'All Events'
,p_lov_return_value=>'A'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(8022798984171058665)
,p_lov_disp_sequence=>2
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(9175239532895097702)
,p_lov_name=>'UPD_REQUEST_AFO'
,p_lov_query=>'.'||wwv_flow_imp.id(9175239532895097702)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(9175239839304097710)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'All Events'
,p_lov_return_value=>'A'
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(9175240046923097717)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Future Events'
,p_lov_return_value=>'F'
,p_lov_disp_cond_type=>'EXPRESSION'
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(9175240250181097717)
,p_lov_disp_sequence=>3
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8022847583294241187)
,p_lov_name=>'UPD_REQUEST_FO'
,p_lov_query=>'.'||wwv_flow_imp.id(8022847583294241187)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(8022848075050241190)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Future Events'
,p_lov_return_value=>'F'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(8022847860546241188)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Only this Event'
,p_lov_return_value=>'O'
);
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(1446834800910516505)
,p_lov_name=>'USERNAME_FORMAT'
,p_lov_query=>'.'||wwv_flow_imp.id(1446834800910516505)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089051329
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(1446835092435516513)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Email Address'
,p_lov_return_value=>'EMAIL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(1446835401527516518)
,p_lov_disp_sequence=>2
...
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(1326182802764730889)
,p_group_name=>'ACL'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(8949470649597181373)
,p_group_name=>'Administration'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(1326189813415752876)
,p_group_name=>'Events'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(1326183104149731211)
,p_group_name=>'Help'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(1326183205188731516)
,p_group_name=>'Home'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(1326191193591766074)
,p_group_name=>'Login'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(1326183513845734035)
,p_group_name=>'Mobile'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(8949469846480180530)
,p_group_name=>'Public'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(1326183791120736948)
,p_group_name=>'Search'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(1326183892159737257)
,p_group_name=>'Tags'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(1326183689735736580)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(8949440934558156549)
,p_name=>' Breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1071971470163430666)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
,p_short_name=>'Application Appearance'
,p_link=>'f?p=&APP_ID.:41:&SESSION.'
,p_page_id=>41
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1326188096585741218)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1335980208878021337)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1348037189071713031)
,p_parent_id=>wwv_flow_imp.id(2479769203737486629)
,p_short_name=>'Time Zone'
,p_link=>'f?p=&APP_ID.:100:&SESSION.::&DEBUG.:::'
,p_page_id=>100
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1446834292238516490)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1446855708961578667)
,p_short_name=>'Add Multiple Users'
,p_link=>'f?p=&APP_ID.:53:&SESSION.::&DEBUG.:::'
,p_page_id=>53
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1446869691805612137)
,p_short_name=>'Add Multiple Users'
,p_link=>'f?p=&APP_ID.:54:&SESSION.::&DEBUG.:::'
,p_page_id=>54
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1683821381473989106)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1785168042711670037)
,p_short_name=>'Timeline of Future Events'
,p_link=>'f?p=&APP_ID.:12:&SESSION.::&DEBUG.:::'
,p_page_id=>12
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1785490777273683750)
,p_short_name=>'Search'
,p_link=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.:::'
,p_page_id=>2
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1785529077793708169)
,p_short_name=>'Tags'
,p_link=>'f?p=&APP_ID.:36:&SESSION.::&DEBUG.:::'
,p_page_id=>36
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1866197119047429523)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1866208856850437346)
,p_parent_id=>wwv_flow_imp.id(1866197119047429523)
,p_short_name=>'Calendar Details'
,p_link=>'f?p=&APP_ID.:44:&SESSION.'
,p_page_id=>44
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1991266316065436014)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2479769203737486629)
,p_parent_id=>wwv_flow_imp.id(3265173690769151426)
,p_short_name=>'Preferences'
,p_link=>'f?p=&APP_ID.:28:&SESSION.'
,p_page_id=>28
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3233032900874265388)
,p_short_name=>'Help'
,p_link=>'f?p=&FLOW_ID.:14:&SESSION.'
,p_page_id=>14
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3265156395415057089)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3265167097718067360)
,p_parent_id=>wwv_flow_imp.id(3265156395415057089)
,p_short_name=>'Notification'
,p_link=>'f?p=&FLOW_ID.:25:&SESSION.'
,p_page_id=>25
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3265172101793115905)
,p_short_name=>'Administration'
,p_link=>'f?p=&APP_ID.:26:&SESSION.::&DEBUG.:::'
,p_page_id=>26
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3265173690769151426)
,p_short_name=>'Home'
,p_link=>'f?p=&FLOW_ID.:1:&SESSION.'
,p_page_id=>1
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3265352986747524444)
,p_parent_id=>wwv_flow_imp.id(3265363990130674688)
,p_short_name=>'User Details'
,p_link=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:::'
,p_page_id=>30
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3265363990130674688)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3265387296944309715)
,p_parent_id=>wwv_flow_imp.id(3265173690769151426)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3265394286555322594)
,p_parent_id=>wwv_flow_imp.id(3265387296944309715)
,p_short_name=>'Attachments'
,p_link=>'f?p=&FLOW_ID.:31:&SESSION.'
,p_page_id=>31
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3265402693770336231)
,p_parent_id=>wwv_flow_imp.id(3265394286555322594)
,p_short_name=>'Attachment'
,p_link=>'f?p=&FLOW_ID.:32:&SESSION.'
,p_page_id=>32
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3266085083185052242)
,p_parent_id=>wwv_flow_imp.id(3265387296944309715)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3266092192134068081)
,p_parent_id=>wwv_flow_imp.id(3265387296944309715)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3314603998472232629)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3343167100485714235)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(7443840242321720034)
,p_parent_id=>wwv_flow_imp.id(1785490777273683750)
,p_short_name=>'Delete Multiple'
,p_link=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:::'
,p_page_id=>13
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8035065288332595537)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8035084566370698436)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
,p_short_name=>'Groups'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8035090680187702697)
,p_parent_id=>wwv_flow_imp.id(8035084566370698436)
,p_short_name=>'Details'
,p_link=>'f?p=&APP_ID.:17:&SESSION.::&DEBUG.:::'
,p_page_id=>17
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8035703064183798941)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8035728581634861926)
,p_parent_id=>wwv_flow_imp.id(8035703064183798941)
,p_short_name=>'Details'
,p_link=>'f?p=&FLOW_ID.:19:&SESSION.'
,p_page_id=>19
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8042337667101234712)
,p_parent_id=>wwv_flow_imp.id(8035703064183798941)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8042417981907319023)
,p_parent_id=>wwv_flow_imp.id(8035703064183798941)
,p_short_name=>'Add Multiple Members'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8043503172828141200)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8043516179586165410)
,p_parent_id=>wwv_flow_imp.id(8043503172828141200)
,p_short_name=>'Details'
,p_link=>'f?p=&FLOW_ID.:24:&SESSION.'
,p_page_id=>24
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8530058694749227244)
,p_parent_id=>wwv_flow_imp.id(8949464138316156709)
,p_short_name=>'Update or Delete Affects'
,p_link=>'f?p=&FLOW_ID.:11:&SESSION.'
,p_page_id=>11
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8949455329543156680)
,p_parent_id=>wwv_flow_imp.id(3265172101793115905)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8949457953680156693)
,p_parent_id=>wwv_flow_imp.id(8949455329543156680)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8949464138316156709)
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(1725294673905837418)
,p_theme_id=>42
...
,p_default_header_template=>wwv_flow_imp.id(1725260028442837330)
,p_default_footer_template=>wwv_flow_imp.id(1725260028442837330)
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(61846428692142852)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(61850455780142855)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(61852455636142856)
,p_theme_id=>42
,p_name=>'ICON_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(61855695162142858)
,p_theme_id=>42
,p_name=>'DISPLAY_MODE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(61864059955142863)
,p_theme_id=>42
,p_name=>'DISPLAY_MODE'
,p_display_name=>'Display Mode'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(61874044026142869)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(61878088955142872)
,p_theme_id=>42
,p_name=>'COLOR_ACCENTS'
,p_display_name=>'Color Accents'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998184487867292556)
,p_theme_id=>142
,p_name=>'ALERT_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998184849510292556)
,p_theme_id=>142
,p_name=>'DISPLAY_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998186737274292560)
,p_theme_id=>142
,p_name=>'REGION_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998187115206292560)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998188787838292565)
,p_theme_id=>142
,p_name=>'BODY_HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998189311403292566)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998189647852292566)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998190682996292566)
,p_theme_id=>142
,p_name=>'REGION_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998191731564292568)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998192427145292569)
,p_theme_id=>142
,p_name=>'BADGE_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998192752227292569)
,p_theme_id=>142
,p_name=>'LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998194848899292576)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998195237944292576)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998195522505292576)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998196884708292579)
,p_theme_id=>142
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998197778277292580)
,p_theme_id=>142
,p_name=>'BADGE_SIZE'
,p_display_name=>'Badge Size'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998199297723292583)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998200454494292584)
,p_theme_id=>142
,p_name=>'ICON_STYLE'
,p_display_name=>'Icon Style'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998202366310292589)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998203542659292591)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998204207515292593)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998205513254292596)
,p_theme_id=>142
,p_name=>'BUTTON_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998205768907292596)
,p_theme_id=>142
,p_name=>'SPACING_LEFT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998206114246292596)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998206543765292596)
,p_theme_id=>142
,p_name=>'BUTTON_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998206791504292596)
,p_theme_id=>142
,p_name=>'BUTTON_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998207306121292596)
,p_theme_id=>142
,p_name=>'BUTTON_SET'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998208163107292596)
,p_theme_id=>142
,p_name=>'BUTTON_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998208664603292596)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998209137259292597)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998209419473292597)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998209670962292597)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(998209980014292597)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1062447631964798458)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1085120685868881036)
,p_theme_id=>142
,p_name=>'CURRENT_PAGE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1244443362062453437)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1244449237068453446)
,p_theme_id=>142
,p_name=>'LIST_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1281021299173470629)
,p_theme_id=>142
,p_name=>'DIALOG_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1281023723392470633)
,p_theme_id=>142
,p_name=>'DISPLAY'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1281042747057470662)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1369471490399705403)
,p_theme_id=>142
,p_name=>'LABEL_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1372972691846062717)
,p_theme_id=>142
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1549216366358152098)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(1640732170941805634)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(1687893729257680057)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(1702191231626766140)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(1866183829626190037)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(1436452313355926089)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(3265344584574491911)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(1536291591354242333)
,p_name=>'ACL_DISABLED'
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(1536291004725236077)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(3264556788778103583)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(1391863588533698060)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(3270229303044355265)
,p_name=>'FEATURES'
,p_message_text=>'Features'
,p_version_scn=>37166093810713
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(3270229506161356203)
,p_name=>'GETTING_STARTED'
,p_message_text=>'Getting Started'
,p_version_scn=>37166093810723
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(2983307902229499730)
,p_name=>'HELP'
,p_message_text=>'Help'
,p_version_scn=>37166093810753
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(1458100296383573329)
,p_name=>'HELP_ABOUT'
,p_message_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="aboutApp">',
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(1458099905873568904)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(1458100100697571326)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(1458100491423575598)
,p_name=>'HELP_SIDEBAR'
,p_message_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(1458099683025564271)
,p_name=>'HELP_SUPPORT'
,p_message_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="textRegion">',
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(1391864409440703506)
...
wwv_flow_imp_shared.create_shortcut(
 p_id=>wwv_flow_imp.id(3266242682691661994)
...
begin
wwv_flow_imp_shared.create_shortcut(
 p_id=>wwv_flow_imp.id(8949445745857156619)
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(8949439553743156471)
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1440585284528158902)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887238672358325439)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887239108692325439)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887239487588325440)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887239908175325442)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887240314430325443)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887240750637325444)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887241089292325444)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887241511790325444)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887241911715325445)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887242343742325445)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887242763518325445)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3887243124034325446)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(3887246770042325465)
,p_plugin_id=>wwv_flow_imp.id(1440585284528158902)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1862777590938683437)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4101943150522108767)
,p_plugin_id=>wwv_flow_imp.id(1862777590938683437)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4101943539156108767)
,p_plugin_id=>wwv_flow_imp.id(1862777590938683437)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4101943958842108768)
,p_plugin_id=>wwv_flow_imp.id(1862777590938683437)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4101944326115108768)
,p_plugin_id=>wwv_flow_imp.id(1862777590938683437)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4101944690347108768)
,p_plugin_id=>wwv_flow_imp.id(1862777590938683437)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4101945080297108768)
,p_plugin_id=>wwv_flow_imp.id(1862777590938683437)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4101945510718108769)
,p_plugin_id=>wwv_flow_imp.id(1862777590938683437)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(4101946470186108770)
,p_plugin_id=>wwv_flow_imp.id(1862777590938683437)
,p_name=>'SOURCE_SQL'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1862780588569683461)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2277173106574518854)
,p_plugin_id=>wwv_flow_imp.id(1862780588569683461)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1862781291031683467)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2475958377332499633)
,p_plugin_id=>wwv_flow_imp.id(1862781291031683467)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2475958828673499633)
,p_plugin_id=>wwv_flow_imp.id(1862781291031683467)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2475959246678499633)
,p_plugin_id=>wwv_flow_imp.id(1862781291031683467)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2475959606733499634)
,p_plugin_id=>wwv_flow_imp.id(1862781291031683467)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1973380043486387685)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170541282561569898)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170541618508569898)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>120
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170542005304569899)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170542434038569899)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170542858186569899)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170543290607569899)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170543600796569900)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170544091413569900)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170544437685569900)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170544815145569905)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170545294565569905)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170545612342569906)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(170546048138569906)
,p_plugin_attribute_id=>wwv_flow_imp.id(170545612342569906)
,p_display_sequence=>10
,p_display_value=>'Timeline'
,p_return_value=>'D'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(170546514455569906)
,p_plugin_attribute_id=>wwv_flow_imp.id(170545612342569906)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170547050647569906)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170547416949569907)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
...
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(170541618508569898)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'NOT_NULL'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(170547894579569907)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(170549140159569908)
,p_plugin_id=>wwv_flow_imp.id(1973380043486387685)
,p_name=>'SOURCE_SQL'
,p_sql_min_column_count=>3
);
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(10073809961445457889)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(683889337153215887)
,p_plugin_id=>wwv_flow_imp.id(10073809961445457889)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(683889722086215887)
,p_plugin_id=>wwv_flow_imp.id(10073809961445457889)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(683890154045215887)
,p_plugin_id=>wwv_flow_imp.id(10073809961445457889)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(683891140058215889)
,p_plugin_id=>wwv_flow_imp.id(10073809961445457889)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(683891878220215889)
,p_plugin_id=>wwv_flow_imp.id(10073809961445457889)
...
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(8949469846480180530)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1225096505705640670)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1225096794507640671)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943385403540257996)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943385807259257999)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943386208833257999)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943392137025262899)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1555728036115052508)
...
,p_required_patch=>wwv_flow_imp.id(1702191231626766140)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1702181813935675780)
,p_plug_name=>'Events Calendar'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1725911133140097826)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1742234615952756806)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1874434296244795791)
,p_plug_name=>'Filters'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1702186528856675827)
,p_name=>'Calendars'
,p_parent_plug_id=>wwv_flow_imp.id(1874434296244795791)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1874433115710795779)
,p_query_column_id=>1
,p_column_alias=>'D'
,p_column_display_sequence=>1
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(5575676116849114589)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1886421602839231687)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(7985325275354686580)
,p_name=>'Event Types'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1874436628899795814)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3266242793426665105)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265442490310733114)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1725911133140097826)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1702185899738675821)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1874434296244795791)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1177128935371413007)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(32838380047194156)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(3265343602666478168)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1893128797062653984)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1725265129512213515)
,p_name=>'Refresh Calendar for Create'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3265442490310733114)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725265167439213516)
,p_event_id=>wwv_flow_imp.id(1725265129512213515)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1702181813935675780)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1702186112300675823)
,p_event_id=>wwv_flow_imp.id(1725265129512213515)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1555728036115052508)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725265595562213520)
,p_event_id=>wwv_flow_imp.id(1725265129512213515)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1874433539727795783)
,p_name=>'Refresh Calendar for Filter'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1702185899738675821)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874433637518795784)
,p_event_id=>wwv_flow_imp.id(1874433539727795783)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874433690215795785)
,p_event_id=>wwv_flow_imp.id(1874433539727795783)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874433981917795788)
,p_event_id=>wwv_flow_imp.id(1874433539727795783)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(7985325275354686580)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874433881769795787)
,p_event_id=>wwv_flow_imp.id(1874433539727795783)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1702186528856675827)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874436781195795816)
,p_event_id=>wwv_flow_imp.id(1874433539727795783)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5575676116849114589)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874433810666795786)
,p_event_id=>wwv_flow_imp.id(1874433539727795783)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1236685896473388522)
,p_name=>'Notifications'
,p_display_sequence=>10
,p_component_template_options=>'#DEFAULT#'
,p_source_type=>'NATIVE_SQL_REPORT'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1236686082835388598)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943408899741278986)
,p_query_column_id=>2
,p_column_alias=>'ALERT_TYPE'
,p_column_display_sequence=>2
,p_column_heading=>'Alert Type'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943409278297278986)
,p_query_column_id=>3
,p_column_alias=>'ALERT_TITLE'
,p_column_display_sequence=>3
,p_column_heading=>'Alert Title'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943409707980278987)
,p_query_column_id=>4
,p_column_alias=>'ALERT_DESC'
,p_column_display_sequence=>4
,p_column_heading=>'Alert Desc'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943410163732278987)
,p_query_column_id=>5
,p_column_alias=>'ALERT_ACTION'
,p_column_display_sequence=>5
,p_column_heading=>'Alert Action'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1785485237843678779)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_imp.id(8949440934558156549)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>4072363345357175094
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3266243593903674638)
,p_plug_name=>'Timezone'
,p_region_css_classes=>'infoTextRegion'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3266758401288098309)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8421753001701999361)
,p_plug_name=>'Events'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8421753200690999363)
...
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(8421753395498999372)
,p_name=>'Details'
,p_display_sequence=>10
);
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(8421753302078999366)
,p_name=>'Audit Info'
,p_display_sequence=>20
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8421753507947999373)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8421754090262999378)
,p_db_column_name=>'EVENT_TYPE'
,p_display_order=>2
,p_group_id=>wwv_flow_imp.id(8421753395498999372)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8421753606435999377)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8421753705942999378)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8421753786377999378)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8421754198082999378)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8421753878175999378)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>11
,p_group_id=>wwv_flow_imp.id(8421753302078999366)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8421754005981999378)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8530042085672173205)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7978264456101321995)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8043494584552102304)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8048406782516536560)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8048406873304536560)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8048406972842536560)
...
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_rpt_named_lov=>wwv_flow_imp.id(8048412175983563031)
,p_rpt_show_filter_lov=>'2'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8048407067744536561)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8048407166499536561)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265426709113520936)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3312914700976129414)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1874434696182795795)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8421754809010999379)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(1886452943728509022)
,p_report_id=>wwv_flow_imp.id(8421754809010999379)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265338981410462611)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1785485237843678779)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265338607945460809)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(869132703028756082)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8421753001701999361)
,p_button_name=>'RESET'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(3265343398510476979)
,p_computation_sequence=>10
,p_computation_item=>'LAST_VIEW'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726264717197955401)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726265642555955411)
,p_event_id=>wwv_flow_imp.id(1726264717197955401)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8421753001701999361)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726265131853955407)
,p_event_id=>wwv_flow_imp.id(1726264717197955401)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1726303033777225598)
,p_name=>'Details'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726303083483225599)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726305227632225620)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3160049715803794504)
,p_query_column_id=>3
...
,p_named_lov=>wwv_flow_imp.id(1866314312150316370)
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726303263688225600)
,p_query_column_id=>4
...
,p_disable_sort_column=>'N'
,p_display_as=>'TEXT_FROM_LOV_ESC'
,p_named_lov=>wwv_flow_imp.id(8949446355080156640)
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726303294933225601)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3160049444349794501)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3160049505272794502)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726303440157225602)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726303538684225603)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726303764132225605)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726303782390225606)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726303867968225607)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726304686149225615)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726304838114225616)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726304966830225617)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726305053412225618)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3160049835441794505)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1726305129725225619)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3160049949182794506)
...
,p_display_as=>'TEXT_FROM_LOV_ESC'
,p_named_lov=>wwv_flow_imp.id(9168187337776708901)
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3160050021538794507)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3160050122457794508)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1874435457943795802)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1940327309639942588)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_list_id=>wwv_flow_imp.id(2204486196811483800)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1950014141013368040)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265236111325780517)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3265239498427795741)
,p_name=>'Updates'
,p_template=>4072358936313175081
,p_display_sequence=>50
,p_include_in_reg_disp_sel_yn=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265239785239795750)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265239892927795750)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1555726618093052494)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265240083868795750)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265240203546795750)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265240309437795750)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265240406287795750)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1555726708104052495)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1555726831022052496)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1555726970915052498)
,p_query_column_id=>10
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1555726932626052497)
,p_query_column_id=>11
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265240813551795750)
,p_query_column_id=>12
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3266080106055034817)
,p_query_column_id=>13
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3265319902911345859)
,p_name=>'Attachments'
,p_template=>4072358936313175081
,p_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265320211309345863)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>2
,p_heading_alignment=>'LEFT'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265320285786345863)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265320411012345863)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265320508699345863)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265320603459345863)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265320709660345864)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265320809384345864)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2316696581007495285)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265320884557345868)
,p_query_column_id=>9
,p_column_alias=>'CREATED'
,p_column_display_sequence=>10
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265321006101345868)
,p_query_column_id=>10
,p_column_alias=>'CREATED_BY'
,p_column_display_sequence=>9
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265378885697173528)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265386998613309712)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265411690357411451)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(7978242063187237868)
,p_name=>'Links'
,p_template=>4072358936313175081
,p_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7978242370954237879)
,p_query_column_id=>1
,p_column_alias=>'NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7978242471948237882)
,p_query_column_id=>2
,p_column_alias=>'URL'
,p_column_display_sequence=>2
,p_column_heading=>'Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265429994185563897)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3265430105791563898)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8421766277516011725)
,p_plug_name=>'Event'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265395411211322811)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3265386998613309712)
,p_button_name=>'PRINT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265243810594827565)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3265236111325780517)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265380595572214202)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3265378885697173528)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8421766492381011727)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265415488064420187)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_imp.id(3265411690357411451)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265243981980827565)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3265236111325780517)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265380812887219259)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(3265378885697173528)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265415800877423910)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265243304923816541)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3265239498427795741)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265326699587430001)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3265319902911345859)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265230386428726002)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3265386998613309712)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265326910322433154)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3265319902911345859)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265334802273449759)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3265239498427795741)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265347193494513439)
,p_button_sequence=>90
,p_button_plug_id=>wwv_flow_imp.id(7978242063187237868)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2204500653399562689)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3266334890700443159)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3265386998613309712)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3265382291594250872)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(533836174827685455)
,p_name=>'P3_PREV_PAGE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(8421766277516011725)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1874435353796795801)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265244611418837356)
,p_name=>'P3_NOTE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3265236111325780517)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265379592885194516)
,p_name=>'P3_FILE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3265378885697173528)
,p_prompt=>'File'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265379812625200205)
,p_name=>'P3_FILE_TAGS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3265378885697173528)
,p_prompt=>'Tags'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265380098904205743)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265411906992411451)
,p_name=>'P3_LINK_NAME_1'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3265411690357411451)
,p_prompt=>'Name 1'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>64
,p_cMaxlength=>255
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265412386336411452)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265412900929411453)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265413384543411453)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265413883382411454)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265414402367411454)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8421768184237011729)
,p_name=>'P3_EVENT_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8421766277516011725)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8421769881935011731)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(3265345301197496715)
,p_computation_sequence=>10
,p_computation_item=>'LAST_VIEW'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1224878624350803652)
...
,p_associated_item=>wwv_flow_imp.id(3265412386336411452)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1224878714766803653)
...
,p_validation_type=>'EXPRESSION'
,p_error_message=>'URL must start with http:// or https://'
,p_associated_item=>wwv_flow_imp.id(3265413384543411453)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1224878830879803654)
...
,p_validation_type=>'EXPRESSION'
,p_error_message=>'URL must start with http:// or https://'
,p_associated_item=>wwv_flow_imp.id(3265414402367411454)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1725778517525854321)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725778920450854328)
,p_event_id=>wwv_flow_imp.id(1725778517525854321)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3265239498427795741)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725779463223854330)
,p_event_id=>wwv_flow_imp.id(1725778517525854321)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3160048927277794496)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3160049038504794497)
,p_event_id=>wwv_flow_imp.id(3160048927277794496)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(7978242063187237868)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3160049080392794498)
,p_event_id=>wwv_flow_imp.id(3160048927277794496)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1725264244321213506)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725264350775213507)
,p_event_id=>wwv_flow_imp.id(1725264244321213506)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3265319902911345859)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725264373559213508)
,p_event_id=>wwv_flow_imp.id(1725264244321213506)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3265422689065467796)
...
,p_process_when_button_id=>wwv_flow_imp.id(3265415800877423910)
,p_process_success_message=>'Links updated'
,p_internal_uid=>3236353891415706059
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3266443982114514459)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3266334890700443159)
,p_internal_uid=>3237375184464752722
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8421785907421038827)
...
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(8949470649597181373)
,p_page_template_options=>'#DEFAULT#:ui-dialog--stretch:t-Dialog--noPadding'
,p_required_role=>wwv_flow_imp.id(3264005803734937606)
,p_protection_level=>'C'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265153897736057078)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3265154100390057078)
,p_name=>'Notifications'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265154197877057081)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265154310712057082)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265154407189057082)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265154495271057082)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265154590809057083)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265154711010057083)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265154803551057083)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265154897417057083)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265154998996057083)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Created By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265155083047057083)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265155202350057083)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265155304270057083)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3265155391561057084)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1487884999949564138)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3265153897736057078)
,p_button_name=>'RESET'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265155595279057085)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3265153897736057078)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726292172218206627)
,p_name=>'Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'JAVASCRIPT_EXPRESSION'
,p_triggering_element=>'window'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726292607316206659)
,p_event_id=>wwv_flow_imp.id(1726292172218206627)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3265153897736057078)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726293076386206659)
,p_event_id=>wwv_flow_imp.id(1726292172218206627)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137661635343726722)
,p_name=>'Refresh on Add'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3265155595279057085)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137661720306726723)
,p_event_id=>wwv_flow_imp.id(137661635343726722)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137661770760726724)
,p_name=>'Refresh on Edit'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(3265153897736057078)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137661962054726725)
,p_event_id=>wwv_flow_imp.id(137661770760726724)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17447868380746579580)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17792374261007890236)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1866169531969175098)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(17792374261007890236)
,p_button_name=>'CANCEL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1893128908728653985)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(17792374261007890236)
,p_button_name=>'RESET'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1866169812076175100)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(17792374261007890236)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1866170507045175113)
,p_name=>'P5_CAL_ALL'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(17447868380746579580)
,p_prompt=>'Calendars'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1866170938720175121)
,p_name=>'P5_CALENDARS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(17447868380746579580)
,p_prompt=>'Calendars'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1866171312289175122)
,p_name=>'P5_ET_ALL'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_imp.id(17447868380746579580)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1866171699106175122)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1866279646586783440)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1866174141085175155)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1866174601853175158)
,p_event_id=>wwv_flow_imp.id(1866174141085175155)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1866175009760175159)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1866175469022175159)
,p_event_id=>wwv_flow_imp.id(1866175009760175159)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1866175871454175159)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1866176430254175160)
,p_event_id=>wwv_flow_imp.id(1866175871454175159)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1866176777422175160)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1866177348033175160)
,p_event_id=>wwv_flow_imp.id(1866176777422175160)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1866177735977175161)
,p_name=>'close'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1866169531969175098)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1866178169309175162)
,p_event_id=>wwv_flow_imp.id(1866177735977175161)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1893129054026653986)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1893128908728653985)
,p_process_success_message=>'All filters reset'
,p_internal_uid=>1864060256376892249
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1866172097018175152)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1866172471990175153)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1702186186366675824)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1866172903853175153)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1866173706515175154)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1866173272633175153)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(816008468080281108)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8949454437018156678)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8949454550558156678)
...
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(9159239458773238664)
,p_name=>'Details'
,p_display_sequence=>10
);
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(9159239930854240001)
,p_name=>'Audit Info'
,p_display_sequence=>20
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8949454657236156679)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8949454751394156679)
,p_db_column_name=>'TYPE_NAME'
,p_display_order=>2
,p_group_id=>wwv_flow_imp.id(9159239458773238664)
,p_column_identifier=>'B'
,p_column_label=>'Event Type'
,p_column_type=>'STRING'
,p_display_text_as=>'WITHOUT_MODIFICATION'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8949579832038658835)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1567778258156154024)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8949454949493156679)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>23
,p_group_id=>wwv_flow_imp.id(9159239930854240001)
,p_column_identifier=>'D'
,p_column_label=>'Created By'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8949455143187156680)
,p_db_column_name=>'LAST_UPDATED_BY'
,p_display_order=>33
,p_group_id=>wwv_flow_imp.id(9159239930854240001)
,p_column_identifier=>'F'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8043479656977043376)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7443822939318687969)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7443823060274687971)
,p_db_column_name=>'CREATED_ON'
,p_display_order=>63
,p_group_id=>wwv_flow_imp.id(9159239930854240001)
,p_column_identifier=>'J'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7443823145236687971)
,p_db_column_name=>'LAST_UPDATED_ON'
,p_display_order=>73
,p_group_id=>wwv_flow_imp.id(9159239930854240001)
,p_column_identifier=>'K'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265221412953648559)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3266504395179861844)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(199248985455611368)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8949584549830673415)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(9168034355571023473)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265221491267651705)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8949454437018156678)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8949457849205156691)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8949454437018156678)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726278397783110444)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726278789623110445)
,p_event_id=>wwv_flow_imp.id(1726278397783110444)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8949454437018156678)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726279303711110445)
,p_event_id=>wwv_flow_imp.id(1726278397783110444)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137662045938726726)
,p_name=>'Refresh on Add'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8949457849205156691)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137662080036726727)
,p_event_id=>wwv_flow_imp.id(137662045938726726)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137662231724726728)
,p_name=>'Refresh on Edit'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(8949454437018156678)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138208996021896279)
,p_event_id=>wwv_flow_imp.id(137662231724726728)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1725265698942213521)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265204396977615531)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3303461392894779859)
,p_plug_name=>'hidden'
,p_plug_display_sequence=>10
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8949455739250156681)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8949455842752156683)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1725265698942213521)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8949455937930156683)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1725265698942213521)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8949456046588156683)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1725265698942213521)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8949456155052156683)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1725265698942213521)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1567778311245154025)
,p_name=>'P8_INTERNAL_YN'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(8949455739250156681)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265204001001607217)
,p_name=>'P8_BORDER_COLOR'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3303461392894779859)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3266505209508875460)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949456340586156686)
,p_name=>'P8_TYPE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8949455739250156681)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949456435025156688)
,p_name=>'P8_TYPE_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8949455739250156681)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949581452816664807)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8036000279369832247)
...
,p_associated_item=>wwv_flow_imp.id(8949456435025156688)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8043476688098023974)
...
,p_when_button_pressed=>wwv_flow_imp.id(8949455937930156683)
,p_associated_item=>wwv_flow_imp.id(8949456435025156688)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1725265789634213522)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8949455842752156683)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725265892995213523)
,p_event_id=>wwv_flow_imp.id(1725265789634213522)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8949457629542156690)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3303463093334836762)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8949457730810156691)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1725266028139213524)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1948940457441741399)
...
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(1326189813415752876)
...
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>wwv_flow_imp.id(3264006312904937606)
,p_protection_level=>'C'
,p_help_text=>'No help is available for this page.'
,p_page_component_map=>'16'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1725264755024213511)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7978196577752043487)
,p_plug_name=>'Links'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8949460330018156700)
,p_plug_name=>'Event'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8949999747855155329)
,p_plug_name=>'Audit Information'
,p_parent_plug_id=>wwv_flow_imp.id(8949460330018156700)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>60
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9168104730084451303)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8532020900381475064)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_imp.id(1725264755024213511)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8949460442411156701)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1725264755024213511)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8949460537091156701)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1725264755024213511)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8949460639765156701)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1725264755024213511)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8949460750110156701)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1725264755024213511)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8530077194055299637)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8530079185229334995)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:1::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8949460537091156701)
,p_branch_sequence=>20
,p_save_state_before_branch_yn=>'Y'
,p_branch_comment=>'Created 08-SEP-2010 20:10 by SBKENNED'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(617734107311086346)
,p_branch_name=>'Go To Home if setting event to recur'
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8949460639765156701)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8949460858515156702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1702186020298675822)
,p_name=>'P10_CALENDAR_ID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(8949460330018156700)
,p_prompt=>'Calendar'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1888254122241050067)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1888254439820053060)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265253106290015594)
,p_name=>'P10_TAGS'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(8949460330018156700)
,p_prompt=>'Tags'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3266342600060521568)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7411707132577763287)
...
,p_lov=>'.'||wwv_flow_imp.id(9168215031992839694)||'.'
,p_field_template=>2318601014859922299
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_protection_level=>'S'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7978161283713950576)
,p_name=>'P10_LINK_NAME_1'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_imp.id(7978196577752043487)
,p_prompt=>'Name 1'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>64
,p_cMaxlength=>255
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7978162861334953539)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7978172163328973068)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7978172671986975582)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7978180459913000469)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7978181067185002507)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8406420280918633799)
,p_name=>'P10_SERIES_ID'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(9168104730084451303)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8530038200271150087)
,p_name=>'P10_LOCATION'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_imp.id(8949460330018156700)
,p_prompt=>'Location'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8530078799989329781)
,p_name=>'P10_RECUR'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_imp.id(9168104730084451303)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8791132834348898308)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8825212318992806269)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949460950337156703)
,p_name=>'P10_EVENT_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8949460330018156700)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949461041697156704)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949461235427156704)
,p_name=>'P10_TYPE_ID'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(8949460330018156700)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949461436327156704)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949462441620156705)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949462637716156706)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949462852858156706)
,p_name=>'P10_CREATED_ON'
,p_item_sequence=>280
,p_item_plug_id=>wwv_flow_imp.id(8949999747855155329)
,p_prompt=>'Created:'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949463151956156706)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949463347598156706)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949463660493156706)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9160824044882682078)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9160824753886684701)
,p_name=>'P10_DURATION'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(8949460330018156700)
,p_prompt=>'End Time'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9168189153707713515)
...
,p_lov=>'.'||wwv_flow_imp.id(9168187337776708901)||'.'
,p_cHeight=>1
,p_field_template=>2526760615038828570
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9168190945526720652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9168206748652797214)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(3801901438002383006)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(8022686377174747511)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(8421497406906376481)
,p_computation_sequence=>20
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1521446387112029757)
...
,p_associated_item=>wwv_flow_imp.id(8825212318992806269)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1874437484791795823)
...
,p_validation_condition2=>'-1'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_imp.id(1888254122241050067)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1874437659349795824)
...
,p_validation_condition2=>'-1'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_associated_item=>wwv_flow_imp.id(1888254439820053060)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_required_patch=>wwv_flow_imp.id(1640732170941805634)
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(9168254353351987748)
...
,p_associated_item=>wwv_flow_imp.id(9168190945526720652)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(9168252936251973371)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(302889854008691841)
...
,p_associated_item=>wwv_flow_imp.id(3265253106290015594)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(494131458016393949)
,p_validation_name=>'URL 1 must start with http'
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_imp.id(7978162861334953539)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(494131532533393950)
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_imp.id(7978172671986975582)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(494131677737393951)
,p_validation_name=>'URL 3 must start with http'
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_imp.id(7978181067185002507)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8421508183189407428)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8421508499447407433)
,p_event_id=>wwv_flow_imp.id(8421508183189407428)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8421665478284652026)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8421665796230652027)
,p_event_id=>wwv_flow_imp.id(8421665478284652026)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(9168221741127851809)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(9168222037747851811)
,p_event_id=>wwv_flow_imp.id(9168221741127851809)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(9168104730084451303)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(9168222228720851812)
,p_event_id=>wwv_flow_imp.id(9168221741127851809)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8825241824420949708)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8825242117855949715)
,p_event_id=>wwv_flow_imp.id(8825241824420949708)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8825242320248949720)
,p_event_id=>wwv_flow_imp.id(8825241824420949708)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8022612066757517409)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8022612381615517414)
,p_event_id=>wwv_flow_imp.id(8022612066757517409)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3312905108446270546)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3312905386546270548)
,p_event_id=>wwv_flow_imp.id(3312905108446270546)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3312905593838270549)
,p_event_id=>wwv_flow_imp.id(3312905108446270546)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1725264798683213512)
,p_name=>'Cancel Dialog'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8949460442411156701)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725264938371213513)
,p_event_id=>wwv_flow_imp.id(1725264798683213512)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8791283405746325281)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Load Data'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(9172090054633555799)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_imp.id(8949460750110156701)
,p_process_success_message=>'Event created.'
,p_internal_uid=>9143021256983794062
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8530077300289301489)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8949460639765156701)
,p_process_success_message=>'Event updated.'
,p_internal_uid=>8501008502639539752
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8530079697350338485)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_imp.id(8949460537091156701)
,p_process_success_message=>'Event deleted.'
,p_internal_uid=>8501010899700576748
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8532022195317483090)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
':P11_REQUEST_TYPE := ''D'';'))
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(8532020900381475064)
,p_internal_uid=>8502953397667721353
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1725265027426213514)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7417890259129679609)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8530051090298227236)
,p_plug_name=>'Scope'
,p_parent_plug_id=>wwv_flow_imp.id(7417890259129679609)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>30
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8532013877263449516)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8532014188077449525)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8532014298434449528)
,p_query_column_id=>2
,p_column_alias=>'EVENT_NAME'
,p_column_display_sequence=>2
,p_column_heading=>'Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8532014391441449528)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7417900232379690850)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8530058288711227243)
,p_plug_name=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8530051700108227237)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8530058288711227243)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8530051888025227238)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8530058288711227243)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8530052286656227238)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(8530058288711227243)
,p_button_name=>'DELETE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8530062299664227258)
,p_branch_name=>'Go To Home'
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8530051888025227238)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3160050236851794509)
,p_branch_name=>'Go Home'
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8530052286656227238)
,p_branch_sequence=>20
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8530051306207227236)
,p_name=>'P11_UPD_REQUEST'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8530051090298227236)
,p_prompt=>'Updates Affect:'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'UPD_REQUEST_AFO'
,p_lov=>'.'||wwv_flow_imp.id(9175239532895097702)||'.'
,p_field_template=>2526760615038828570
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8530070301234245003)
,p_name=>'P11_DEL_REQUEST'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(7417900232379690850)
,p_item_default=>'A'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8530071704828255485)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8530059806996227250)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Update'
...
,p_process_when_button_id=>wwv_flow_imp.id(8530051888025227238)
,p_process_success_message=>'Event(s) updated.'
,p_internal_uid=>8500991009346465513
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8530060009239227250)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_imp.id(8530052286656227238)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1236686499936389475)
,p_name=>'Notifications'
,p_display_sequence=>10
,p_component_template_options=>'#DEFAULT#'
,p_source_type=>'NATIVE_SQL_REPORT'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1236686693049389491)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943397732620271527)
,p_query_column_id=>2
,p_column_alias=>'ALERT_TYPE'
,p_column_display_sequence=>2
,p_column_heading=>'Alert Type'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943398100952271527)
,p_query_column_id=>3
,p_column_alias=>'ALERT_TITLE'
,p_column_display_sequence=>3
,p_column_heading=>'Alert Title'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943398487379271527)
,p_query_column_id=>4
,p_column_alias=>'ALERT_DESC'
,p_column_display_sequence=>4
,p_column_heading=>'Alert Desc'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1943398881935271527)
,p_query_column_id=>5
,p_column_alias=>'ALERT_ACTION'
,p_column_display_sequence=>5
,p_column_heading=>'Alert Action'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1725911270558097828)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1977332848572616062)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1547003109871258108)
,p_name=>'COLOR_CLASS'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1555727644065052504)
,p_name=>'LINK'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1555727735288052505)
,p_name=>'CREATED'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1555727775006052506)
,p_name=>'TIME'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977333108271616066)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'NUMBER'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977333597122616069)
,p_name=>'TITLE'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977334587137616073)
,p_name=>'EVENT_TYPE'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977335100234616074)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977337119529616075)
,p_name=>'EVENT_DESC'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977337617547616075)
,p_name=>'LOCATION'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977338125690616076)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977338625669616076)
,p_name=>'TAGS'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977340131316616079)
,p_name=>'DISPLAY_TIME'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977340587966616080)
,p_name=>'LINK_NAME_1'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977341128534616081)
,p_name=>'LINK_NAME_2'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977341663566616082)
,p_name=>'LINK_NAME_3'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977342107320616083)
,p_name=>'LINK_URL_1'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977342624161616083)
,p_name=>'LINK_URL_2'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1977343089390616083)
,p_name=>'LINK_URL_3'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3266243388362673040)
,p_plug_name=>'Timezone'
,p_region_css_classes=>'infoTextRegion'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3720835572952323999)
,p_plug_name=>'Filters'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3548587805564204035)
,p_name=>'Calendars'
,p_parent_plug_id=>wwv_flow_imp.id(3720835572952323999)
,p_template=>4072358936313175081
,p_display_sequence=>80
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--removeHeader js-removeLandmark:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#:t-Report--stretch:t-Report--altRowsDefault:t-Report--rowHighlight'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1877982868570969305)
,p_query_column_id=>1
,p_column_alias=>'D'
,p_column_display_sequence=>1
,p_column_heading=>'Calendars'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3720834512918323988)
,p_name=>'Contact Email'
,p_parent_plug_id=>wwv_flow_imp.id(3720835572952323999)
,p_template=>4072358936313175081
,p_display_sequence=>90
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1877982235941969304)
,p_query_column_id=>1
,p_column_alias=>'CONTACT_EMAIL'
,p_column_display_sequence=>1
,p_column_heading=>'Contact Email'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(9831726552062214788)
,p_name=>'Event Types'
,p_parent_plug_id=>wwv_flow_imp.id(3720835572952323999)
,p_template=>4072358936313175081
,p_display_sequence=>70
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1874436670138795815)
,p_query_column_id=>1
,p_column_alias=>'EVENT_TYPES'
,p_column_display_sequence=>1
,p_column_heading=>'Event Types'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265442210957729569)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1725911270558097828)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1877986961344982023)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3720835572952323999)
,p_button_name=>'FILTER'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--noUI:t-Button--iconRight:t-Button--gapLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3265439603722680253)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(3265343809938480297)
,p_computation_sequence=>10
,p_computation_item=>'LAST_VIEW'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1702182412361675786)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1702182553804675787)
,p_event_id=>wwv_flow_imp.id(1702182412361675786)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1977332848572616062)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726261217451933782)
,p_name=>'Refresh Timeline for Create'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3265442210957729569)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726261591596933790)
,p_event_id=>wwv_flow_imp.id(1726261217451933782)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725265493998213519)
,p_event_id=>wwv_flow_imp.id(1726261217451933782)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1874436939629795817)
,p_name=>'Refresh Timeline for Filter'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1877986961344982023)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874437152647795819)
,p_event_id=>wwv_flow_imp.id(1874436939629795817)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(9831726552062214788)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874437249835795820)
,p_event_id=>wwv_flow_imp.id(1874436939629795817)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3548587805564204035)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874437297195795821)
,p_event_id=>wwv_flow_imp.id(1874436939629795817)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3720834512918323988)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874436994834795818)
,p_event_id=>wwv_flow_imp.id(1874436939629795817)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3720835572952323999)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874437456885795822)
,p_event_id=>wwv_flow_imp.id(1874436939629795817)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1983154598727999887)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7443833044428719986)
,p_plug_name=>'Filter'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(7443838656815720011)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7443838951062720021)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7443839053749720021)
,p_query_column_id=>2
,p_column_alias=>'EVENT_NAME'
,p_column_display_sequence=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7443839145749720021)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7443839235633720021)
,p_query_column_id=>4
,p_column_alias=>'EVENT_DATE'
,p_column_display_sequence=>1
,p_column_heading=>'Event Date'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7443839359375720022)
,p_query_column_id=>5
,p_column_alias=>'START_TIME'
,p_column_display_sequence=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7443839435230720022)
,p_query_column_id=>6
,p_column_alias=>'END_TIME'
,p_column_display_sequence=>4
,p_column_heading=>'End Time'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7443839558195720022)
,p_query_column_id=>7
,p_column_alias=>'DURATION'
,p_column_display_sequence=>5
,p_column_heading=>'Duration'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7443838858225720019)
,p_query_column_id=>8
,p_column_alias=>'EVENT_DESC'
,p_column_display_sequence=>9
,p_column_heading=>'Description'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1874434811359795796)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7443839645956720023)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7443969558570958442)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(7443833044428719986)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3266527791305398706)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1983154598727999887)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7443835949263720004)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1983154598727999887)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7443834835252720000)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(7443833044428719986)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(7443987242471991601)
,p_branch_name=>'Go To Page 13'
,p_branch_action=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(7443835949263720004)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
,p_branch_comment=>'Created 18-OCT-2010 12:49 by SBKENNED'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(7443842042888720064)
,p_branch_action=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:13::'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(7443969558570958442)
,p_branch_sequence=>20
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1874434879325795797)
,p_name=>'P13_CALENDAR_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(7443833044428719986)
,p_prompt=>'Calendar'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'CALENDARS WITH DEFAULT'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7443833241300719991)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7443833844202719999)
,p_name=>'P13_END_DATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(7443833044428719986)
,p_prompt=>'Until'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7443834343599720000)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7443835033247720000)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(7443841545370720057)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(7443841847188720062)
,p_event_id=>wwv_flow_imp.id(7443841545370720057)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7443841357868720047)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_imp.id(7443835949263720004)
,p_process_success_message=>'Event(s) deleted.'
,p_internal_uid=>7414772560218958310
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7443987450783994076)
,p_process_sequence=>20
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
...
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(1326183104149731211)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2036684898491323741)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2077266060245411791)
,p_name=>'&APPLICATION_TITLE.'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2077266145560411792)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2077266186992411793)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2077266338319411794)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3233031097012265377)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1458106111233870296)
,p_plug_name=>'About this Application'
,p_parent_plug_id=>wwv_flow_imp.id(3233031097012265377)
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1458106681905874367)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1458107296797878672)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1458107700952879896)
,p_plug_name=>'Support'
,p_parent_plug_id=>wwv_flow_imp.id(3233031097012265377)
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(141141424403983160)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8023154364901088564)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8023154672938088566)
,p_query_column_id=>1
,p_column_alias=>'EVENT_ID'
,p_column_display_sequence=>2
,p_column_heading=>'Event Id'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8023154788016088568)
,p_query_column_id=>2
,p_column_alias=>'EVENT_NAME'
,p_column_display_sequence=>6
,p_column_heading=>'Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8023154876397088568)
,p_query_column_id=>3
,p_column_alias=>'EVENT_TYPE'
,p_column_display_sequence=>7
,p_column_heading=>'Type'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8023154977148088568)
,p_query_column_id=>4
,p_column_alias=>'EVENT_DATE'
,p_column_display_sequence=>1
,p_column_heading=>'Event Date'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7418422556170615376)
,p_query_column_id=>5
,p_column_alias=>'START_TIME'
,p_column_display_sequence=>3
,p_column_heading=>'Timing'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7418422656623615377)
,p_query_column_id=>6
,p_column_alias=>'END_TIME'
,p_column_display_sequence=>4
,p_column_heading=>'End Time'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(7418422748856615377)
,p_query_column_id=>7
,p_column_alias=>'DURATION'
,p_column_display_sequence=>5
,p_column_heading=>'Duration'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8023155259906088568)
,p_query_column_id=>8
,p_column_alias=>'EVENT_DESC'
,p_column_display_sequence=>8
,p_column_heading=>'Description'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8023163286214102965)
,p_plug_name=>'Filter'
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8035064988525595530)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8035922083629265865)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2444171955531223482)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8035922083629265865)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7443973142556972790)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8023163286214102965)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1900544927898191728)
,p_button_sequence=>120
,p_button_plug_id=>wwv_flow_imp.id(8035064988525595530)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8035940961437382454)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8035064988525595530)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8023207680420158007)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8023163286214102965)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8023207881790158008)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(7443983161256978145)
,p_branch_action=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.:15::'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(7443973142556972790)
,p_branch_sequence=>20
,p_save_state_before_branch_yn=>'Y'
,p_branch_comment=>'Created 18-OCT-2010 12:47 by SBKENNED'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7429059431872204383)
,p_name=>'P15_FROM'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(8035922083629265865)
,p_prompt=>'From'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>64
,p_cMaxlength=>4000
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7435002436801353837)
,p_name=>'P15_TO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8035922083629265865)
,p_prompt=>'To (emails)'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8023159774440099569)
,p_name=>'P15_START_DATE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(8023163286214102965)
,p_prompt=>'From'
,p_format_mask=>'&APP_DATE_FORMAT.'
,p_display_as=>'NATIVE_DATE_PICKER_APEX'
,p_cSize=>16
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8023201069900145593)
,p_name=>'P15_END_DATE'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(8023163286214102965)
,p_prompt=>'Until'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8023203988600150950)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035922975795273100)
,p_name=>'P15_GROUP_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8035922083629265865)
,p_prompt=>'To (group)'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035923360342278037)
,p_name=>'P15_SUBJECT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(8035922083629265865)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035926672378300458)
,p_name=>'P15_MSG_BODY'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(8035922083629265865)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8072090081976316772)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(141140901661983155)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8035939762345373211)
...
,p_when_button_pressed=>wwv_flow_imp.id(8035940961437382454)
,p_associated_item=>wwv_flow_imp.id(8035922975795273100)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(7429087960231259825)
...
,p_when_button_pressed=>wwv_flow_imp.id(8035940961437382454)
,p_associated_item=>wwv_flow_imp.id(7429059431872204383)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8035940171349375866)
...
,p_when_button_pressed=>wwv_flow_imp.id(8035940961437382454)
,p_associated_item=>wwv_flow_imp.id(8035923360342278037)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8035940482777379140)
...
,p_when_button_pressed=>wwv_flow_imp.id(8035940961437382454)
,p_associated_item=>wwv_flow_imp.id(8035926672378300458)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(7435019442651402862)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(141141258726983158)
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_imp.id(7435002436801353837)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8042459976568488105)
,p_name=>'save group id'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8042460277673488149)
,p_event_id=>wwv_flow_imp.id(8042459976568488105)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2444171967463223483)
,p_name=>'New'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P15_GROUP_ID'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2444172124170223484)
,p_event_id=>wwv_flow_imp.id(2444171967463223483)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(2444171955531223482)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2444172260781223485)
,p_event_id=>wwv_flow_imp.id(2444171967463223483)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8035944469580422579)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_imp.id(8035940961437382454)
,p_process_success_message=>'Email(s) sent.'
,p_internal_uid=>8006875671930660842
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7443986456885986353)
,p_process_sequence=>20
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_RESET_PAGINATION'
,p_process_name=>'Reset Pagination'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8035082169967698409)
,p_plug_name=>'Groups'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--noBorders'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8035082359107698412)
,p_name=>'EBA_CA_EVENT_TYPES'
,p_max_row_count=>'10000'
,p_max_row_count_message=>'This query returns more than 10,000 rows, please filter your data to ensure complete results.'
...
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(8035082577162698419)
,p_name=>'Details'
,p_display_sequence=>10
);
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(8035082484771698416)
,p_name=>'Audit Info'
,p_display_sequence=>20
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035082859260698424)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>1
,p_group_id=>wwv_flow_imp.id(8035082484771698416)
,p_column_identifier=>'D'
,p_column_label=>'Created By'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035082970172698424)
,p_db_column_name=>'LAST_UPDATED_BY'
,p_display_order=>2
,p_group_id=>wwv_flow_imp.id(8035082484771698416)
,p_column_identifier=>'F'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035092367111711783)
,p_db_column_name=>'GROUP_NAME'
,p_display_order=>3
,p_group_id=>wwv_flow_imp.id(8035082577162698419)
,p_column_identifier=>'H'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035912088037210387)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035092264948711781)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035912172958210388)
,p_db_column_name=>'CREATED_ON'
,p_display_order=>6
,p_group_id=>wwv_flow_imp.id(8035082484771698416)
,p_column_identifier=>'J'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035912257030210388)
,p_db_column_name=>'LAST_UPDATED_ON'
,p_display_order=>7
,p_group_id=>wwv_flow_imp.id(8035082484771698416)
,p_column_identifier=>'K'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8035083387352698425)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8035083582864698429)
,p_application_user=>'APXWS_ALTERNATIVE'
,p_name=>'with Audit Info'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2444171743195223480)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8035082169967698409)
,p_button_name=>'RESET'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8035083757954698431)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8035082169967698409)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726311106779266979)
,p_name=>'Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'JAVASCRIPT_EXPRESSION'
,p_triggering_element=>'window'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726311515944266979)
,p_event_id=>wwv_flow_imp.id(1726311106779266979)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8035082169967698409)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726311991295266980)
,p_event_id=>wwv_flow_imp.id(1726311106779266979)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138209396373896283)
,p_name=>'Refresh on Add'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8035083757954698431)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138209515309896284)
,p_event_id=>wwv_flow_imp.id(138209396373896283)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138209592978896285)
,p_name=>'Refresh on Edit'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(8035082169967698409)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138209754990896286)
,p_event_id=>wwv_flow_imp.id(138209592978896285)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1726301350187225581)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8035085666994702682)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8035088079103702693)
,p_plug_name=>'Audit Information'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8035085869637702683)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1726301350187225581)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8035086476287702684)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1726301350187225581)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8035086069783702683)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1726301350187225581)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8035086283130702684)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1726301350187225581)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035086683659702688)
,p_name=>'P17_GROUP_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8035085666994702682)
,p_use_cache_before_default=>'NO'
,p_source=>'GROUP_ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035086865535702691)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035088262434702695)
,p_name=>'P17_CREATED_ON'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8035088079103702693)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Created:'
,p_source=>'CREATED_ON'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035088782011702695)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035089284147702696)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035089767099702696)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8036001363486856044)
...
,p_associated_item=>wwv_flow_imp.id(8035086865535702691)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726301442748225582)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8035085869637702683)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726301479070225583)
,p_event_id=>wwv_flow_imp.id(1726301442748225582)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8035090769942702697)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8035090988006702701)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1726301585417225584)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8035700764355798928)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8035700979363798931)
,p_name=>'EBA_CA_EVENT_TYPES'
,p_max_row_count=>'10000'
,p_max_row_count_message=>'This query returns more than 10,000 rows, please filter your data to ensure complete results.'
...
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(8035701170170798932)
,p_name=>'Details'
,p_display_sequence=>10
);
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(8035701086573798932)
,p_name=>'Audit Info'
,p_display_sequence=>20
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035701273997798932)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>4
,p_group_id=>wwv_flow_imp.id(8035701086573798932)
,p_column_identifier=>'D'
,p_column_label=>'Created By'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035701365003798934)
,p_db_column_name=>'LAST_UPDATED_BY'
,p_display_order=>5
,p_group_id=>wwv_flow_imp.id(8035701086573798932)
,p_column_identifier=>'F'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035701563860798935)
,p_db_column_name=>'GROUP_NAME'
,p_display_order=>7
,p_group_id=>wwv_flow_imp.id(8035701170170798932)
,p_column_identifier=>'H'
,p_column_label=>'Group Name'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035705474915809218)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035705586219809219)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035913378256226485)
,p_db_column_name=>'CREATED_ON'
,p_display_order=>10
,p_group_id=>wwv_flow_imp.id(8035701086573798932)
,p_column_identifier=>'K'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035913471004226486)
,p_db_column_name=>'LAST_UPDATED_ON'
,p_display_order=>11
,p_group_id=>wwv_flow_imp.id(8035701086573798932)
,p_column_identifier=>'L'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8035913567477226486)
,p_db_column_name=>'GROUP_ID'
,p_display_order=>12
,p_group_id=>wwv_flow_imp.id(8035701170170798932)
,p_column_identifier=>'M'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8035701865116798935)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8035702060845798936)
,p_application_user=>'APXWS_ALTERNATIVE'
,p_name=>'with Audit Info'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8035702684440798937)
,p_plug_name=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2444171784364223481)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8035700764355798928)
,p_button_name=>'RESET'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8042508869969684787)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8035700764355798928)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8035702264463798936)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(8035700764355798928)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726320740033366141)
,p_name=>'Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'JAVASCRIPT_EXPRESSION'
,p_triggering_element=>'window'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726321142353366141)
,p_event_id=>wwv_flow_imp.id(1726320740033366141)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8035700764355798928)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726321646284366142)
,p_event_id=>wwv_flow_imp.id(1726320740033366141)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1726301763119225585)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8035724085292861914)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8035724273476861915)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1726301763119225585)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8035724888729861917)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1726301763119225585)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8035724661386861917)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1726301763119225585)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8035724458358861916)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1726301763119225585)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035725066578861918)
,p_name=>'P19_MBR_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_imp.id(8035724085292861914)
,p_use_cache_before_default=>'NO'
,p_source=>'MBR_ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035725257799861919)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8035733386699888319)
,p_name=>'P19_GROUP_ID'
,p_is_required=>true
,p_item_sequence=>1.5
,p_item_plug_id=>wwv_flow_imp.id(8035724085292861914)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(8035910888599201029)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8036014557439967800)
...
,p_associated_item=>wwv_flow_imp.id(8035725257799861919)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8036001968812867040)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(55941599400520080)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8035724273476861915)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(55941711769520081)
,p_event_id=>wwv_flow_imp.id(55941599400520080)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8035728674182861927)
,p_process_sequence=>1
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8035728859186861929)
,p_process_sequence=>1
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(55942468767520089)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2445498816245405411)
,p_name=>'Group Members'
,p_template=>4072358936313175081
,p_display_sequence=>20
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2445499249176405412)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2445499629609405413)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2445500018594405414)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2445499629609405413)
,p_button_name=>'CLOSE'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2445500441691405414)
,p_name=>'P20_GROUP_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2445498816245405411)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(229203340687918089)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2445500018594405414)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(229203385331918090)
,p_event_id=>wwv_flow_imp.id(229203340687918089)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(55941864940520082)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8042272258281948827)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8042337383766234704)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8042273087148948840)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(55941864940520082)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8042273386395948840)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(55941864940520082)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(7418117060560058485)
,p_branch_action=>'f?p=&APP_ID.:18:&SESSION.::&DEBUG.:21,22::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8042273087148948840)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
,p_branch_comment=>'Created 14-OCT-2010 11:46 by SBKENNED'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8042273757208948848)
,p_branch_action=>'f?p=&APP_ID.:22:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8042273386395948840)
,p_branch_sequence=>20
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8042272781227948835)
,p_name=>'P21_MBRS'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8042272258281948827)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8042272977497948840)
,p_name=>'P21_GROUP_ID'
,p_is_required=>true
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_imp.id(8042272258281948827)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8042331958224208441)
,p_name=>'P21_LB'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_imp.id(8042272258281948827)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(55941944115520083)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8042273087148948840)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(55942058854520084)
,p_event_id=>wwv_flow_imp.id(55941944115520083)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8042303282101063892)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(8042273386395948840)
,p_internal_uid=>8013234484451302155
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7418115649478055297)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'   p_collection_name => ''BULK_MBRS_INVALID'' );'))
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(8042273087148948840)
,p_internal_uid=>7389046851828293560
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8042281468800974917)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(55942080554520085)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8042310083318102119)
,p_name=>'Valid Emails'
,p_template=>4072358936313175081
,p_display_sequence=>10
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--scrollBody'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8042310358155102139)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8042310765441106406)
,p_name=>'Invalid Data'
,p_template=>4072358936313175081
,p_display_sequence=>20
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--scrollBody'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8042311081650106412)
,p_query_column_id=>1
,p_column_alias=>'EMAIL'
,p_column_display_sequence=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8042311188706106412)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8042417680789319019)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8042274870458948856)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(55942080554520085)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8042274957708948856)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(55942080554520085)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8042275079281948856)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(55942080554520085)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8042274768173948855)
,p_name=>'P22_GROUP_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8042310083318102119)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Group:'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select group_name',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(55942252432520086)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8042274870458948856)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(55942360774520087)
,p_event_id=>wwv_flow_imp.id(55942252432520086)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8042315761547124202)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_imp.id(8042274957708948856)
,p_process_success_message=>'Members created.'
,p_internal_uid=>8013246963897362465
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7418109454757037829)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(55942453210520088)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8043500778858141157)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8043500969923141173)
,p_name=>'EBA_CA_EVENT_TYPES'
,p_max_row_count=>'10000'
,p_max_row_count_message=>'This query returns more than 10,000 rows, please filter your data to ensure complete results.'
...
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(8043501166203141176)
,p_name=>'Details'
,p_display_sequence=>10
);
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(8043501087878141175)
,p_name=>'Audit Info'
,p_display_sequence=>20
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8043501267666141178)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>4
,p_group_id=>wwv_flow_imp.id(8043501087878141175)
,p_column_identifier=>'D'
,p_column_label=>'Created By'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8043501368798141179)
,p_db_column_name=>'LAST_UPDATED_BY'
,p_display_order=>5
,p_group_id=>wwv_flow_imp.id(8043501087878141175)
,p_column_identifier=>'F'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8043503957379147582)
,p_db_column_name=>'TF_ID'
,p_display_order=>6
,p_group_id=>wwv_flow_imp.id(8043501166203141176)
,p_column_identifier=>'G'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8043504069856147582)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8043504185249147582)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8043504259443147583)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8043542286786279042)
,p_db_column_name=>'CREATED_ON'
,p_display_order=>10
,p_group_id=>wwv_flow_imp.id(8043501087878141175)
,p_column_identifier=>'K'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8043542381175279044)
,p_db_column_name=>'LAST_UPDATED_ON'
,p_display_order=>11
,p_group_id=>wwv_flow_imp.id(8043501087878141175)
,p_column_identifier=>'L'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8043501964753141181)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(8048410688319557221)
,p_report_id=>wwv_flow_imp.id(8043501964753141181)
,p_name=>'Future'
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_expr_type=>'ROW'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8043502175667141187)
,p_application_user=>'APXWS_ALTERNATIVE'
,p_name=>'with Audit Info'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(8043541580207277118)
,p_report_id=>wwv_flow_imp.id(8043502175667141187)
,p_name=>'Future'
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_expr_type=>'ROW'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1949289431857848704)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8043500778858141157)
,p_button_name=>'reset'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8043502376647141188)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8043500778858141157)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726283249021163487)
,p_name=>'Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'JAVASCRIPT_EXPRESSION'
,p_triggering_element=>'window'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726283633670163487)
,p_event_id=>wwv_flow_imp.id(1726283249021163487)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8043500778858141157)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726284118047163488)
,p_event_id=>wwv_flow_imp.id(1726283249021163487)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137661255862726718)
,p_name=>'Refresh on Add'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8043502376647141188)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137661331109726719)
,p_event_id=>wwv_flow_imp.id(137661255862726718)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137661445642726720)
,p_name=>'Refresh on Edit'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(8043500778858141157)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137661527171726721)
,p_event_id=>wwv_flow_imp.id(137661445642726720)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1725266153528213525)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8043511683571165376)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8043513377872165400)
,p_plug_name=>'Audit Information'
,p_region_template_options=>'#DEFAULT#:is-collapsed:t-Region--noBorder:t-Region--scrollBody'
,p_plug_template=>2664334895415463485
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8043511868182165386)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1725266153528213525)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8043512480191165389)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1725266153528213525)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8043512056131165389)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1725266153528213525)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8043512281866165389)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1725266153528213525)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8043512682926165390)
,p_name=>'P24_TF_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8043511683571165376)
,p_use_cache_before_default=>'NO'
,p_source=>'TF_ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8043512860331165394)
,p_name=>'P24_TF_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8043511683571165376)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8043513566527165400)
,p_name=>'P24_CREATED_ON'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(8043513377872165400)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Created:'
,p_source=>'CREATED_ON'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8043514084324165401)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8043514559576165401)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8043515063718165402)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8043524977988191323)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8043527280544201535)
,p_name=>'P24_END_DATE'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(8043511683571165376)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8043516365214165415)
...
,p_associated_item=>wwv_flow_imp.id(8043512860331165394)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137661006179726716)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8043511868182165386)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137661104190726717)
,p_event_id=>wwv_flow_imp.id(137661006179726716)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8043516461550165417)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8043516670394165430)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1725266265132213526)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1363397113264828856)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1725266321636213527)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265163781130067356)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1455747002707206137)
,p_plug_name=>'Notification Items'
,p_parent_plug_id=>wwv_flow_imp.id(3265163781130067356)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>40
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265164185817067356)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1725266321636213527)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265164412593067356)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1725266321636213527)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265164588911067356)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1725266321636213527)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265163993457067356)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1725266321636213527)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265164789900067357)
,p_name=>'P25_DISPLAY_SEQUENCE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(1455747002707206137)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265165007271067358)
,p_name=>'P25_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1455747002707206137)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265165195615067358)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265165390887067358)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265165582702067358)
...
,p_lov=>'.'||wwv_flow_imp.id(3265168406235067362)||'.'
,p_cHeight=>1
,p_field_template=>1609122147107268652
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265166009521067358)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265166181862067359)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3265167302184067360)
,p_validation_name=>'P25_DISPLAY_FROM must be timestamp'
,p_validation_sequence=>10
,p_validation=>'P25_DISPLAY_FROM'
,p_validation_type=>'ITEM_IS_TIMESTAMP'
,p_error_message=>'#LABEL# must be a valid timestamp.'
,p_associated_item=>wwv_flow_imp.id(3265166009521067358)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3265167494110067361)
,p_validation_name=>'P25_DISPLAY_UNTIL must be timestamp'
,p_validation_sequence=>20
,p_validation=>'P25_DISPLAY_UNTIL'
,p_validation_type=>'ITEM_IS_TIMESTAMP'
,p_error_message=>'#LABEL# must be a valid timestamp.'
,p_associated_item=>wwv_flow_imp.id(3265166181862067359)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1585579183468086328)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1725266450069213528)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3265164185817067356)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726301068747225579)
,p_event_id=>wwv_flow_imp.id(1725266450069213528)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3265167603372067361)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3265167796850067361)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3265167996751067361)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
...
,p_attribute_04=>'31'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3265164412593067356)
,p_internal_uid=>3236099199101305624
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1726301238731225580)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1256071695643929481)
...
,p_plug_query_row_template=>wwv_flow_imp.id(7535557433160598253)
,p_plug_query_headings_type=>'QUERY_COLUMNS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1536461086346063657)
,p_plug_name=>'Access Control Settings'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>40
,p_plug_new_grid_row=>false
,p_plug_required_role=>wwv_flow_imp.id(3264005803734937606)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML',
  'show_line_breaks', 'N')).to_clob
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(138209811824896287)
,p_plug_name=>'ACL Info'
,p_parent_plug_id=>wwv_flow_imp.id(1536461086346063657)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(138209924956896288)
,p_name=>'User Counts'
,p_parent_plug_id=>wwv_flow_imp.id(1536461086346063657)
,p_template=>4072358936313175081
,p_display_sequence=>30
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138210051184896289)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138210073930896290)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(138210232532896291)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1742234706017756807)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3264010609681964371)
...
,p_plug_display_sequence=>40
,p_plug_display_point=>'SUB_REGIONS'
,p_list_id=>wwv_flow_imp.id(3264011192861964374)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_plug_required_role=>wwv_flow_imp.id(3264005803734937606)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1742234782470756808)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1785485542370678782)
,p_plug_name=>'breadcrumbs'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1874436562192795813)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3264009983332964369)
...
,p_plug_display_sequence=>10
,p_plug_new_grid_column=>false
,p_list_id=>wwv_flow_imp.id(3264012509532964376)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3264010189499964370)
,p_plug_name=>'Hidden Items'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3264857101290835790)
,p_plug_name=>'Email'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#:u-colors'
,p_plug_template=>4072358936313175081
...
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
,p_list_id=>wwv_flow_imp.id(8035067569609599620)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3343170506046735630)
...
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
,p_list_id=>wwv_flow_imp.id(3343169996194735628)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1256071987463936624)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1256071695643929481)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1256072198198939709)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1256071695643929481)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(3265343983058481982)
,p_computation_sequence=>10
,p_computation_item=>'LAST_VIEW'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3264010984593964372)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(787187649496820901)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2671892088230732193)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(141990889598004010)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(787187649496820901)
,p_button_name=>'SAVE'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#:t-Button--gapLeft'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(141990536038004008)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(787187649496820901)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(309320021843065194)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141991633445004011)
,p_name=>'P27_AC_ENABLED'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2671892088230732193)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141992066895004014)
...
,p_lov=>'.'||wwv_flow_imp.id(142001054409004032)||'.'
,p_field_template=>1609121967514267634
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141992458469004014)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141992818126004015)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(141995089144004023)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141995651024004024)
,p_event_id=>wwv_flow_imp.id(141995089144004023)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141996081081004024)
,p_event_id=>wwv_flow_imp.id(141995089144004023)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(141997418864004025)
,p_name=>'APPLY CHANGES WHEN AC ENABLED'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(141990889598004010)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141997897247004025)
,p_event_id=>wwv_flow_imp.id(141997418864004025)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(141998330638004026)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141998829748004026)
,p_event_id=>wwv_flow_imp.id(141998330638004026)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141999328195004026)
,p_event_id=>wwv_flow_imp.id(141998330638004026)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(141999739526004026)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(142000177071004027)
,p_event_id=>wwv_flow_imp.id(141999739526004026)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(141996541514004025)
,p_name=>'Cancel Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(141990536038004008)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141997041759004025)
,p_event_id=>wwv_flow_imp.id(141996541514004025)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(141993954304004022)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(141994351081004022)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(141994678265004023)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(141993545820004022)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2479768279751486626)
...
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_list_id=>wwv_flow_imp.id(2479769812353486631)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2479768844828486628)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(2479769524457486629)
,p_computation_sequence=>10
,p_computation_item=>'LAST_VIEW'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(1326182802764730889)
,p_javascript_code=>wwv_flow_string.join(wwv_flow_t_varchar2(
'function refreshParent() {',
'    parent.location.reload();',
'}'))
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265336105509456804)
,p_plug_name=>'Users'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--noBorders'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>40
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3265336308441456810)
,p_name=>'Users'
,p_max_row_count=>'100000'
,p_max_row_count_message=>'This query returns more than #MAX_ROW_COUNT# rows, please filter your data to ensure complete results.'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265336405798456815)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265336511387456816)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265336786570456817)
...
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_rpt_named_lov=>wwv_flow_imp.id(3265361500307657276)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265336607529456817)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>6
,p_column_identifier=>'D'
,p_column_label=>'Created By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265336685633456817)
,p_db_column_name=>'CREATED'
,p_display_order=>7
,p_column_identifier=>'E'
,p_column_label=>'Created'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1350711993846912842)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1874434581827795794)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3265336906464456818)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1350934208481263375)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3265336105509456804)
,p_button_name=>'RESET'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1446876886241878204)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3265336105509456804)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265337111962456822)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3265336105509456804)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1521129505368439371)
,p_computation_sequence=>10
,p_computation_item=>'LAST_VIEW'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726462253216553216)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'JAVASCRIPT_EXPRESSION'
,p_triggering_element=>'window'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726462649480553217)
,p_event_id=>wwv_flow_imp.id(1726462253216553216)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3265336105509456804)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726463128499553217)
,p_event_id=>wwv_flow_imp.id(1726462253216553216)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138210439793896293)
,p_name=>'Refresh on Add'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3265337111962456822)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138210544744896294)
,p_event_id=>wwv_flow_imp.id(138210439793896293)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138210615245896295)
,p_name=>'Refresh on bulk add'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1446876886241878204)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138210747234896296)
,p_event_id=>wwv_flow_imp.id(138210615245896295)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138210849385896297)
,p_name=>'Refresh on Edit'
,p_event_sequence=>40
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(3265336105509456804)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138210930445896298)
,p_event_id=>wwv_flow_imp.id(138210849385896297)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1726301808555225586)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265348201343524388)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1516443689480725645)
,p_plug_name=>'Form Items'
,p_parent_plug_id=>wwv_flow_imp.id(3265348201343524388)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>30
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265348812727524389)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1726301808555225586)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265348590414524388)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1726301808555225586)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265348504859524388)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1726301808555225586)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1446878007974903399)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265348406285524388)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1726301808555225586)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1874434504218795793)
,p_name=>'P30_RESTRICTED_TO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3265348201343524388)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265349589273524395)
,p_name=>'P30_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3265348201343524388)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265349796708524433)
,p_name=>'P30_USERNAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3265348201343524388)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265349999839524434)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265350186281524435)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1446878293935907491)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1521131085705494030)
,p_computation_sequence=>20
,p_computation_item=>'LAST_VIEW'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(3265360403162639184)
...
,p_when_button_pressed=>wwv_flow_imp.id(3265348504859524388)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1521130494128475003)
...
,p_validation_condition2=>'PLSQL'
,p_validation_condition_type=>'EXPRESSION'
,p_associated_item=>wwv_flow_imp.id(3265349796708524433)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726301888598225587)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3265348812727524389)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726301998044225588)
,p_event_id=>wwv_flow_imp.id(1726301888598225587)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3265352182120524441)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3265352388113524443)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3265352583419524443)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3265348590414524388)
,p_internal_uid=>3236283785769762706
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1726302196870225590)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265391004320322564)
,p_plug_name=>'Button Bar'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265391995063322569)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3265392185750322570)
,p_name=>'Links'
,p_max_row_count=>'100000'
,p_max_row_count_message=>'This query returns more than #MAX_ROW_COUNT# rows, please filter your data to ensure complete results.'
...
,p_detail_link_auth_scheme=>wwv_flow_imp.id(3264006312904937606)
,p_owner=>'MIKE'
,p_internal_uid=>2594250504666917254
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265392288021322576)
,p_db_column_name=>'TAGS'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Tags'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265392399808322584)
,p_db_column_name=>'CREATED'
,p_display_order=>4
,p_column_identifier=>'D'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265392512589322584)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>5
,p_column_identifier=>'E'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265392607845322584)
,p_db_column_name=>'UPDATED'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Updated'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265392708058322584)
,p_db_column_name=>'UPDATED_BY'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Updated By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265392789393322584)
,p_db_column_name=>'ID'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265392913668322584)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265392995739322584)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265393087787322585)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265393213183322585)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265393299476322585)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3265395691257326549)
,p_db_column_name=>'EVENT_ID'
,p_display_order=>19
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3265393508611322586)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265393904733322589)
,p_plug_name=>'BC'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265391385719322566)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3265393904733322589)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265391198285322565)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3265391995063322569)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(3265394902838322600)
,p_branch_action=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265391605679322566)
,p_name=>'P31_DELETE_FILE_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3265391004320322564)
,p_use_cache_before_default=>'NO'
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265391813211322567)
,p_name=>'P31_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3265391004320322564)
,p_prompt=>'Event Name:'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1973162889591695405)
,p_computation_sequence=>10
,p_computation_item=>'LAST_VIEW'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(3265394481554322596)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1725784240988958574)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725784613751958575)
,p_event_id=>wwv_flow_imp.id(1725784240988958574)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3265391995063322569)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725785083125958575)
,p_event_id=>wwv_flow_imp.id(1725784240988958574)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3265394588982322598)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1725263436246213498)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3265399683699336226)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265399886602336226)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1725263436246213498)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265400091443336227)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_imp.id(1725263436246213498)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265400506896336227)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1725263436246213498)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3265400306422336227)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1725263436246213498)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265400703468336228)
,p_name=>'P32_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3265399683699336226)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265400889836336228)
,p_name=>'P32_EVENT_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3265399683699336226)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265401094236336228)
,p_name=>'P32_FILENAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3265399683699336226)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265401283778336228)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265401487092336228)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265401709897336228)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3265401899097336229)
,p_name=>'P32_TAGS'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(3265399683699336226)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1725263631181213500)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3265399886602336226)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725263711717213501)
,p_event_id=>wwv_flow_imp.id(1725263631181213500)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3265402790708336231)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3265402986910336233)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3265403193028336233)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3265400091443336227)
,p_internal_uid=>3236334395378574496
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1725263517414213499)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1725262727720213491)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3266082890183052227)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3266083106037052229)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1725262727720213491)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3266083281296052231)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1725262727720213491)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3266083512693052231)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1725262727720213491)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3266083690208052231)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1725262727720213491)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3266083905252052232)
,p_name=>'P33_EVENT_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3266082890183052227)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Event Name:'
,p_source=>'EVENT_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3266084111095052234)
,p_name=>'P33_NOTE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3266082890183052227)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3266084289205052234)
,p_name=>'P33_ID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3266082890183052227)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1725262851480213492)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(3266083106037052229)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725262949841213493)
,p_event_id=>wwv_flow_imp.id(1725262851480213492)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3266085198871052244)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3266085389050052245)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3266085581773052245)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(3266083281296052231)
,p_internal_uid=>3237016784123290508
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1725262978865213494)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3266089611695068075)
,p_name=>'Updates'
,p_template=>4072358936313175081
,p_display_sequence=>20
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3266089806112068077)
,p_query_column_id=>1
,p_column_alias=>'CLASS'
,p_column_display_sequence=>1
,p_column_heading=>'Class'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3266089890091068078)
,p_query_column_id=>2
,p_column_alias=>'NOTE_TYPE'
,p_column_display_sequence=>2
,p_column_heading=>'Note Type'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1555727112473052499)
,p_query_column_id=>3
,p_column_alias=>'COMMENT_TEXT'
,p_column_display_sequence=>9
,p_column_heading=>'Comment text'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3266090085032068079)
,p_query_column_id=>4
,p_column_alias=>'ATTRIBUTE_1'
,p_column_display_sequence=>3
,p_column_heading=>'Attribute 1'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3266090197068068079)
,p_query_column_id=>5
,p_column_alias=>'ATTRIBUTE_2'
,p_column_display_sequence=>4
,p_column_heading=>'Attribute 2'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3266090285700068079)
,p_query_column_id=>6
,p_column_alias=>'ATTRIBUTE_3'
,p_column_display_sequence=>5
,p_column_heading=>'Attribute 3'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3266090411486068079)
,p_query_column_id=>7
,p_column_alias=>'ATTRIBUTE_4'
,p_column_display_sequence=>6
,p_column_heading=>'Attribute 4'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1555727188453052500)
,p_query_column_id=>8
,p_column_alias=>'USER_NAME'
,p_column_display_sequence=>10
,p_column_heading=>'User name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1555727285487052501)
,p_query_column_id=>9
,p_column_alias=>'COMMENT_DATE'
,p_column_display_sequence=>11
,p_column_heading=>'Comment date'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1555727394014052502)
,p_query_column_id=>10
,p_column_alias=>'USER_ICON'
,p_column_display_sequence=>12
,p_column_heading=>'User icon'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1555727501797052503)
,p_query_column_id=>11
,p_column_alias=>'ACTIONS'
,p_column_display_sequence=>13
,p_column_heading=>'Actions'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3266090788711068079)
,p_query_column_id=>12
,p_column_alias=>'CREATED'
,p_column_display_sequence=>7
,p_column_heading=>'Created'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(3266090912353068079)
,p_query_column_id=>13
,p_column_alias=>'NOTE_ID'
,p_column_display_sequence=>8
,p_column_heading=>'Note Id'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3266091010366068079)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noPadding:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3266091797758068080)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1725262593065213490)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3266091797758068080)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3266091193373068079)
,p_name=>'P34_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3266091010366068079)
,p_prompt=>'Event Name:'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_named_lov=>'EVENTS'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(3266092392073068081)
,p_computation_sequence=>10
,p_computation_item=>'P3_EVENT_ID'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(3266092592898068082)
,p_computation_sequence=>10
,p_computation_item=>'LAST_VIEW'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1725263115518213495)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'JAVASCRIPT_EXPRESSION'
,p_triggering_element=>'window'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725263224733213496)
,p_event_id=>wwv_flow_imp.id(1725263115518213495)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3266089611695068075)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1725263276283213497)
,p_event_id=>wwv_flow_imp.id(1725263115518213495)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1326186381259741213)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1326186613096741214)
,p_name=>'Report 1'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1326186692128741214)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1326186805848741216)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1326186909167741216)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1326186989308741216)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1326187086415741216)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1326187212165741216)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1326187291610741217)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1326187399770741217)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1326187596397741217)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1326186381259741213)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(1326183892159737257)
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1785485434420678781)
,p_plug_name=>'breadcrumbs'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3266104806774201510)
,p_plug_name=>'Tags'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3266245498883685583)
,p_plug_name=>'Timezone'
,p_region_css_classes=>'infoTextRegion'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1335980008294021337)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1335985694105059705)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1335986081422065476)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1335980008294021337)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1335986794582069332)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1335980008294021337)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1335990094477094051)
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1335986794582069332)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(174699775475387084)
,p_name=>'P37_APPLICATION_SUBTITLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1335985694105059705)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1335987295568078351)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137660510272726711)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1335986081422065476)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137660616486726712)
,p_event_id=>wwv_flow_imp.id(137660510272726711)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1335989009042092417)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1335986794582069332)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1446833099652516441)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1446834090986516488)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1446833281980516443)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1446834090986516488)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1446833490447516446)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1446834090986516488)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1446834688427516499)
,p_branch_action=>'f?p=&APP_ID.:&LAST_VIEW.:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1446833490447516446)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1446833709190516447)
,p_name=>'P38_USERNAME_FORMAT'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1446833099652516441)
,p_use_cache_before_default=>'NO'
...
,p_lov=>'.'||wwv_flow_imp.id(1446834800910516505)||'.'
,p_field_template=>2526760615038828570
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1446834409340516494)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'#SQLERRM#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1446833490447516446)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16616584263268720514)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(16616584471004720514)
,p_name=>'Build Options'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1683816394036989076)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1683816844662989077)
,p_db_column_name=>'BUILD_OPTION'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Build Option'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1683817186654989077)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1683817601764989078)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1683818050014989078)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1683818374736989078)
,p_db_column_name=>'UPDATED'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Updated'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1683818790978989079)
,p_db_column_name=>'UPDATED_BY'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Updated By'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(16616585254199720516)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1683819665773989089)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(16616584263268720514)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1683820626917989100)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(16616584263268720514)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1683821572532989115)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'update'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1683820626917989100)
,p_process_success_message=>'Build Status(es) updated.'
,p_internal_uid=>1654752774883227378
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(138209353962896282)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2883707066378716272)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1071969436441430664)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2883707066378716272)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1071969825179430664)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(2883707066378716272)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1071972629948430667)
,p_branch_name=>'Go To Page settings'
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1071969436441430664)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1071970231782430664)
,p_name=>'P41_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2883707066378716272)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1071970575102430665)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(138209158246896280)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1071969436441430664)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(138209211187896281)
,p_event_id=>wwv_flow_imp.id(138209158246896280)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1071972100251430667)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17590113191518113781)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(17590113633858113782)
,p_name=>'EBA_CA_EVENT_TYPES'
,p_max_row_count=>'10000'
,p_max_row_count_message=>'This query returns more than 10,000 rows, please filter your data to ensure complete results.'
...
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(17590114142522113785)
,p_name=>'Details'
,p_display_sequence=>10
);
wwv_flow_imp_page.create_worksheet_col_group(
 p_id=>wwv_flow_imp.id(17590113688738113784)
,p_name=>'Audit Info'
,p_display_sequence=>20
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1866190451958429497)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>4
,p_group_id=>wwv_flow_imp.id(17590113688738113784)
,p_column_identifier=>'D'
,p_column_label=>'Created By'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1866190780888429499)
,p_db_column_name=>'LAST_UPDATED_BY'
,p_display_order=>5
,p_group_id=>wwv_flow_imp.id(17590113688738113784)
,p_column_identifier=>'F'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1866191220923429499)
,p_db_column_name=>'CNT_EVENTS'
,p_display_order=>7
,p_group_id=>wwv_flow_imp.id(17590114142522113785)
,p_column_identifier=>'I'
,p_column_label=>'Number of Events'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'LEFT'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1866191634664429499)
,p_db_column_name=>'CREATED_ON'
,p_display_order=>8
,p_group_id=>wwv_flow_imp.id(17590113688738113784)
,p_column_identifier=>'J'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1866192031142429500)
,p_db_column_name=>'LAST_UPDATED_ON'
,p_display_order=>9
,p_group_id=>wwv_flow_imp.id(17590113688738113784)
,p_column_identifier=>'K'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1866192418100429500)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1866192770769429500)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1866193193056429501)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1866193664647429501)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1866194066611429501)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1702185794829675820)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(17590128902708113794)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(17590129405901113798)
,p_application_user=>'APXWS_ALTERNATIVE'
,p_name=>'with Audit Info'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1866195589275429515)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(17590113191518113781)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1866196297053429517)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(17590113191518113781)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137659789551726704)
,p_name=>'Refresh on Add'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1866196297053429517)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137659932820726705)
,p_event_id=>wwv_flow_imp.id(137659789551726704)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(17590113191518113781)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137660294099726709)
,p_name=>'Refresh on Edit'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(17590113191518113781)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137660460512726710)
,p_event_id=>wwv_flow_imp.id(137660294099726709)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1991263083898436002)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1991263493790436002)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1991265090426436006)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1991263083898436002)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1991264311007436006)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1991263083898436002)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1991263964337436002)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1991263083898436002)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1991264674721436006)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1991263083898436002)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137660702528726713)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1991265090426436006)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137660786581726714)
,p_event_id=>wwv_flow_imp.id(137660702528726713)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1991266501996436017)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1991264674721436006)
,p_process_success_message=>'Sample data reset.'
,p_security_scheme=>wwv_flow_imp.id(3264005803734937606)
,p_internal_uid=>1962197704346674280
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1991266936883436020)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1991264311007436006)
,p_process_success_message=>'Sample Data Removed'
,p_security_scheme=>wwv_flow_imp.id(3264005803734937606)
,p_internal_uid=>1962198139233674283
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1991267319479436020)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1991263964337436002)
,p_process_success_message=>'Sample Data Loaded.'
,p_security_scheme=>wwv_flow_imp.id(3264005803734937606)
,p_internal_uid=>1962198521829674283
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(137660897657726715)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1874435624143795804)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1874435697968795805)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1874435788091795806)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17590160927443179298)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17590163016307179300)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>40
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(17828113802584585361)
,p_name=>'Contributors'
,p_template=>4072358936313175081
,p_display_sequence=>50
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--scrollBody'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1866207627113437344)
,p_query_column_id=>1
,p_column_alias=>'USERNAME'
,p_column_display_sequence=>1
,p_column_heading=>'Username'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1866208065679437345)
,p_query_column_id=>2
,p_column_alias=>'ACCESS_TYPE'
,p_column_display_sequence=>2
,p_column_heading=>'Access Type'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1874435566274795803)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1866206080780437341)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(17590163016307179300)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--gapLeft'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1866206543902437342)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(17590163016307179300)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1866205764883437341)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(17590163016307179300)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1866206904074437342)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(17590163016307179300)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1702185669544675819)
,p_name=>'P44_PUBLIC_VIEW_YN'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(17590160927443179298)
,p_use_cache_before_default=>'NO'
,p_item_default=>'Y'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1866201389461437336)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1866201825517437336)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1866202736617437339)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1866203580290437339)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1866204503104437340)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1866209158724437347)
...
,p_associated_item=>wwv_flow_imp.id(1866202736617437339)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1866209889100437348)
...
,p_associated_item=>wwv_flow_imp.id(1866201825517437336)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1866209499053437347)
,p_validation_name=>'no related events before delete'
,p_validation_sequence=>20
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select 1 from EBA_ca_events',
...
,p_when_button_pressed=>wwv_flow_imp.id(1866206904074437342)
,p_associated_item=>wwv_flow_imp.id(1866202736617437339)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1874436175718795810)
,p_name=>'Show Readers'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874436305036795811)
,p_event_id=>wwv_flow_imp.id(1874436175718795810)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1874435624143795804)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1874436427546795812)
,p_event_id=>wwv_flow_imp.id(1874436175718795810)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(137659989744726706)
,p_name=>'CNX'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1866205764883437341)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(137660141069726707)
,p_event_id=>wwv_flow_imp.id(137659989744726706)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1866210195213437348)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1866210626437437348)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(137660258747726708)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'close'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1726302327912225591)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2175461829432229096)
,p_plug_name=>'Wizard'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>100
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1446853681429578660)
,p_plug_name=>'Wizard Items'
,p_parent_plug_id=>wwv_flow_imp.id(2175461829432229096)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1446854894716578662)
,p_plug_name=>'Hidden Items'
,p_parent_plug_id=>wwv_flow_imp.id(2175461829432229096)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1446853293253578659)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1726302327912225591)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1446853490760578660)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1726302327912225591)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1446856282029578676)
,p_branch_action=>'f?p=&APP_ID.:54:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1446853490760578660)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1446853888028578660)
,p_name=>'P53_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1446853681429578660)
,p_item_default=>'2'
,p_prompt=>'Role'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'ACCESS_LEVEL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1446854098046578661)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1446855112993578662)
,p_name=>'P53_USERNAME_FORMAT1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1446854894716578662)
,p_use_cache_before_default=>'NO'
,p_source=>'eba_ca_fw.get_preference_value (''USERNAME_FORMAT'')'
,p_source_type=>'EXPRESSION'
,p_source_language=>'PLSQL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1886414808267874145)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1446855900307578668)
,p_computation_sequence=>10
,p_computation_item=>'LAST_VIEW'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'STATIC_ASSIGNMENT'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726302382387225592)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1446853293253578659)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726302560272225593)
,p_event_id=>wwv_flow_imp.id(1726302382387225592)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1446855984646578671)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'#SQLERRM@'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1446853490760578660)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1446865985495612121)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1446866200030612123)
,p_name=>'Exceptions'
,p_parent_plug_id=>wwv_flow_imp.id(1446865985495612121)
,p_template=>4072358936313175081
,p_display_sequence=>100
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--stretch:t-Report--altRowsDefault:t-Report--rowHighlight'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1446866483831612126)
,p_query_column_id=>1
,p_column_alias=>'USERNAME'
,p_column_display_sequence=>1
,p_column_heading=>'Username'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1446866410286612126)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1446866588021612127)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1446866903830612132)
,p_plug_name=>'Hidden Items'
,p_plug_display_sequence=>10
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1446867708511612133)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1446868898644612136)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1446869112401612136)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1726302653599225594)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1446868081812612134)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1726302653599225594)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1446868504340612134)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1726302653599225594)
,p_button_name=>'FINISH'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1446868299006612134)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1726302653599225594)
,p_button_name=>'PREVIOUS'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1446870104569612141)
,p_branch_action=>'f?p=&APP_ID.:29:&SESSION.::&DEBUG.:53,&APP_PAGE_ID.::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1446868504340612134)
,p_branch_sequence=>10
,p_security_scheme=>wwv_flow_imp.id(3264005803734937606)
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1446867092296612132)
,p_name=>'P54_ROLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1446866903830612132)
,p_use_cache_before_default=>'NO'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'if :P53_ROLE = 3 then',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1446867306857612133)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1446867491803612133)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1726302733584225595)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1446868081812612134)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1726302824755225596)
,p_event_id=>wwv_flow_imp.id(1726302733584225595)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1446869811931612139)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'#SQLERRM#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1446868504340612134)
,p_process_success_message=>'User(s) added.'
,p_internal_uid=>1417801014281850402
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1726302902798225597)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3142534015221343464)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5919795484158284866)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7023374186672060674)
,p_plug_name=>'User Details'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5919795690738286795)
,p_plug_name=>'Form Items'
,p_parent_plug_id=>wwv_flow_imp.id(7023374186672060674)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1177264760511580954)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3142534015221343464)
,p_button_name=>'CREATE_AGAIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1177265067712580954)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3142534015221343464)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1177264363510580953)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3142534015221343464)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1177263873102580952)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_imp.id(3142534015221343464)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1177263508563580952)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(3142534015221343464)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1177270084124580987)
...
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1177264760511580954)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1177261065939580947)
,p_name=>'P92_USERNAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(5919795690738286795)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>64
,p_cMaxlength=>255
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1177261877175580950)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1177262865827580951)
,p_name=>'P92_SEQUENCE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(5919795690738286795)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1177266776321580982)
,p_validation_name=>'cannot update yourself'
,p_validation_sequence=>10
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select 1',
...
,p_validation_type=>'NOT_EXISTS'
,p_error_message=>'You cannot update your own record.'
,p_when_button_pressed=>wwv_flow_imp.id(1177264363510580953)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1177266419962580982)
...
,p_validation_condition2=>'PLSQL'
,p_validation_condition_type=>'EXPRESSION'
,p_associated_item=>wwv_flow_imp.id(1177261065939580947)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1177265976340580981)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1177269104255580984)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1177263508563580952)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1177269621937580986)
,p_event_id=>wwv_flow_imp.id(1177269104255580984)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1177267128670580982)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1177268348788580983)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1177264363510580953)
,p_internal_uid=>1148199551138819246
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1177267892221580983)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1177263873102580952)
,p_internal_uid=>1148199094571819246
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1177267487404580983)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1177268672359580984)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1177264760511580954)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1348036906669713023)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7989566078714348217)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7989572187072379074)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1348036906669713023)
,p_button_name=>'CLOSE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3266170805763309058)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1348036906669713023)
,p_button_name=>'APPLY_CHANGES'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(7989568969140364795)
,p_branch_action=>'f?p=&APP_ID.:&LAST_VIEW.:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7989566271956348222)
,p_name=>'P100_TIMEZONE'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(7989566078714348217)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7989566583909349807)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_process_when_button_id=>wwv_flow_imp.id(3266170805763309058)
...
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(1326191193591766074)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8949440153468156487)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3152303699797650489)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8949440153468156487)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1335995090355126341)
,p_name=>'P101_APP_NAME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8949440153468156487)
,p_use_cache_before_default=>'NO'
,p_source=>'nvl(:APPLICATION_TITLE, :APP_NAME)'
,p_source_type=>'EXPRESSION'
,p_source_language=>'PLSQL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949440247754156492)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8949440356461156496)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3272592881152768541)
,p_name=>'Set Focus'
,p_event_sequence=>10
,p_triggering_condition_type=>'JAVASCRIPT_EXPRESSION'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3272593205339768542)
,p_event_id=>wwv_flow_imp.id(3272592881152768541)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3272593394245768545)
,p_event_id=>wwv_flow_imp.id(3272592881152768541)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8949440649122156549)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8949440543661156496)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8949440838242156549)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8949440740608156549)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3314601185382232622)
,p_plug_name=>'Errors'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--noBorders'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(3314601406026232622)
,p_name=>'Errors'
,p_max_row_count=>'100000'
,p_max_row_count_message=>'This query returns more than #MAX_ROW_COUNT# rows, please filter your data to ensure complete results.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314601493828232622)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314601610169232625)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314601699224232625)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314601809399232626)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314601898748232626)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314601983791232626)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314602084948232626)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314602206602232626)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314602293487232627)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314602403296232627)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314602495532232627)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314602596431232627)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314602706987232627)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314602789617232628)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314602890208232628)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314603005021232628)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(3314603097828232628)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1419208012834749962)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(3314603193032232628)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3339153696518770249)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3314601185382232622)
,p_button_name=>'RESET'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3149466912286816223)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3149466782353816222)
,p_plug_name=>'Welcome to &APPLICATION_TITLE.'
,p_parent_plug_id=>wwv_flow_imp.id(3149466912286816223)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3149466958750816224)
,p_plug_name=>'Access Control'
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3149469134315816245)
,p_plug_name=>'ACL Level'
,p_parent_plug_id=>wwv_flow_imp.id(3149466958750816224)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3149467102568816225)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3149467219687816226)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3149469592160816250)
,p_name=>'Feature Configuration'
,p_parent_plug_id=>wwv_flow_imp.id(3149467219687816226)
,p_template=>4501440665235496320
,p_display_sequence=>10
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177107534524369099)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177107960511369099)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177108287901369099)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177108756086369100)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177109086328369100)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177109507795369100)
,p_query_column_id=>6
,p_column_alias=>'UPDATED'
,p_column_display_sequence=>6
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177109888144369100)
,p_query_column_id=>7
,p_column_alias=>'UPDATED_BY'
,p_column_display_sequence=>7
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3149470506719816259)
,p_plug_name=>'Users'
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3149467758919816232)
,p_name=>'Users'
,p_parent_plug_id=>wwv_flow_imp.id(3149470506719816259)
,p_template=>4501440665235496320
,p_display_sequence=>10
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177104098596369091)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177103341977369091)
,p_query_column_id=>2
,p_column_alias=>'USERNAME'
,p_column_display_sequence=>1
,p_column_heading=>'Username'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177102949903369090)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177101685681369089)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1387782638912998292)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177103751906369091)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177102070478369089)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1177102488171369090)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3160797876517075820)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1177110624544369102)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3160797876517075820)
,p_button_name=>'OK'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1177104553182369092)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3149467758919816232)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1177114914187369119)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1177100329682369085)
,p_name=>'P1000_ACL_CONFIG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3149469134315816245)
,p_item_default=>'PUBLIC_READONLY'
,p_prompt=>'Access Control Level'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'ACCESS CONTROL SCOPE'
,p_lov=>'.'||wwv_flow_imp.id(3264553283679047526)||'.'
,p_field_template=>3031561666792084173
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1177100677993369086)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1177106471673369096)
,p_name=>'P1000_LOAD_SAMPLE_YN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3149467102568816225)
,p_item_default=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1177113934514369118)
,p_name=>'Refresh on edit'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(3149467758919816232)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1177114408922369119)
,p_event_id=>wwv_flow_imp.id(1177113934514369118)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3149467758919816232)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1177112183981369114)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1177111046268369112)
,p_process_sequence=>20
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1177111381792369113)
,p_process_sequence=>30
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1177111820292369113)
,p_process_sequence=>40
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1177112627400369114)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2798848434078728819)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2798848654212728821)
,p_plug_name=>'About this Page'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1458948791180444218)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2798848434078728819)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1458949635152444219)
,p_name=>'P1001_PAGE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2798848654212728821)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
...
-- sqlcl_snapshot {"hash":"ee5cc9f6f6af9a33483bf375096750f43fd74a9d","type":"APEX_APPLICATIONS","name":"f115","schemaName":"JESS_DEV_1","sxml":""}